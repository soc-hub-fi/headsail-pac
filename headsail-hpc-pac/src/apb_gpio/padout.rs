...
pub type PadoutR = crate::FieldReader<u32>;
#[doc = "Field `PADOUT` writer - "]
pub type PadoutW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn padout(&self) -> PadoutR {
        PadoutR::new(self.bits)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn padout(&mut self) -> PadoutW<PadoutSpec> {
        PadoutW::new(self, 0)
    }
}
