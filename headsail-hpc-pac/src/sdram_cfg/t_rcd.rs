...
pub type R = crate::R<TRcdSpec>;
#[doc = "Register `t_rcd` writer"]
pub type W = crate::W<TRcdSpec>;
#[doc = "Field `t_rcd` reader - "]
pub type TRcdR = crate::FieldReader<u32>;
#[doc = "Field `t_rcd` writer - "]
pub type TRcdW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn t_rcd(&self) -> TRcdR {
        TRcdR::new(self.bits)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn t_rcd(&mut self) -> TRcdW<TRcdSpec> {
        TRcdW::new(self, 0)
    }
}
