...
pub type R = crate::R<T_WR_SPEC>;
#[doc = "Register `t_wr` writer"]
pub type W = crate::W<T_WR_SPEC>;
#[doc = "Field `t_wr` reader - "]
pub type T_WR_R = crate::FieldReader<u32>;
#[doc = "Field `t_wr` writer - "]
pub type T_WR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn t_wr(&mut self) -> T_WR_W<T_WR_SPEC> {
        T_WR_W::new(self, 0)
    }
}
