#[doc = "Register `gpio0_pad_conf` reader"]
pub type R = crate::R<GPIO0_PAD_CONF_SPEC>;
#[doc = "Register `gpio0_pad_conf` writer"]
pub type W = crate::W<GPIO0_PAD_CONF_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ds0(&mut self) -> DS0_W<GPIO0_PAD_CONF_SPEC> {
        DS0_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ds1(&mut self) -> DS1_W<GPIO0_PAD_CONF_SPEC> {
        DS1_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn st0(&mut self) -> ST0_W<GPIO0_PAD_CONF_SPEC> {
        ST0_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn st1(&mut self) -> ST1_W<GPIO0_PAD_CONF_SPEC> {
        ST1_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn rate_control(&mut self) -> RATE_CONTROL_W<GPIO0_PAD_CONF_SPEC> {
        RATE_CONTROL_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn output_en(&mut self) -> OUTPUT_EN_W<GPIO0_PAD_CONF_SPEC> {
        OUTPUT_EN_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HOLD_W<GPIO0_PAD_CONF_SPEC> {
        HOLD_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pull_enable(&mut self) -> PULL_ENABLE_W<GPIO0_PAD_CONF_SPEC> {
        PULL_ENABLE_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pull_dir(&mut self) -> PULL_DIR_W<GPIO0_PAD_CONF_SPEC> {
        PULL_DIR_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn input_en(&mut self) -> INPUT_EN_W<GPIO0_PAD_CONF_SPEC> {
        INPUT_EN_W::new(self, 9)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio0_pad_conf::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio0_pad_conf::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPIO0_PAD_CONF_SPEC;
impl crate::RegisterSpec for GPIO0_PAD_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio0_pad_conf::R`](R) reader structure"]
impl crate::Readable for GPIO0_PAD_CONF_SPEC {}
#[doc = "`write(|w| ..)` method takes [`gpio0_pad_conf::W`](W) writer structure"]
impl crate::Writable for GPIO0_PAD_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets gpio0_pad_conf to value 0"]
impl crate::Resettable for GPIO0_PAD_CONF_SPEC {
