...
pub type R = crate::R<SdioSdcmdSpec>;
#[doc = "Register `sdio_sdcmd` writer"]
pub type W = crate::W<SdioSdcmdSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ds0(&mut self) -> Ds0W<SdioSdcmdSpec> {
        Ds0W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ds1(&mut self) -> Ds1W<SdioSdcmdSpec> {
        Ds1W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn st0(&mut self) -> St0W<SdioSdcmdSpec> {
        St0W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn st1(&mut self) -> St1W<SdioSdcmdSpec> {
        St1W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn rate_control(&mut self) -> RateControlW<SdioSdcmdSpec> {
        RateControlW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn output_en(&mut self) -> OutputEnW<SdioSdcmdSpec> {
        OutputEnW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HoldW<SdioSdcmdSpec> {
        HoldW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pull_enable(&mut self) -> PullEnableW<SdioSdcmdSpec> {
        PullEnableW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pull_dir(&mut self) -> PullDirW<SdioSdcmdSpec> {
        PullDirW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn input_en(&mut self) -> InputEnW<SdioSdcmdSpec> {
        InputEnW::new(self, 9)
    }
}
...
pub struct SdioSdcmdSpec;
impl crate::RegisterSpec for SdioSdcmdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sdio_sdcmd::R`](R) reader structure"]
impl crate::Readable for SdioSdcmdSpec {}
#[doc = "`write(|w| ..)` method takes [`sdio_sdcmd::W`](W) writer structure"]
impl crate::Writable for SdioSdcmdSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets sdio_sdcmd to value 0"]
impl crate::Resettable for SdioSdcmdSpec {
