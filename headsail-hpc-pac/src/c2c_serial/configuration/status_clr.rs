...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wr_error_0(&mut self) -> WR_ERROR_0_W<STATUS_CLR_SPEC> {
        WR_ERROR_0_W::new(self, 2)
    }
    #[doc = "Bit 3 - Acknowledging rd_error status bit. Clearing rd_error status flag by setting '1'"]
    #[inline(always)]
    #[must_use]
