...
pub type R = crate::R<ADDRESS_MAPPING_RX_SPEC>;
#[doc = "Register `ADDRESS_MAPPING_RX` writer"]
pub type W = crate::W<ADDRESS_MAPPING_RX_SPEC>;
...
pub type ADDRESS_MAPPING_RX_R = crate::FieldReader<u32>;
...
pub type ADDRESS_MAPPING_RX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn address_mapping_rx(&mut self) -> ADDRESS_MAPPING_RX_W<ADDRESS_MAPPING_RX_SPEC> {
        ADDRESS_MAPPING_RX_W::new(self, 0)
    }
}
