...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn destination_mode_set(&mut self) -> DestinationModeSetW<DestinationModeSetSpec> {
...
pub struct DestinationModeSetSpec;
impl crate::RegisterSpec for DestinationModeSetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`destination_mode_set::W`](W) writer structure"]
impl crate::Writable for DestinationModeSetSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DESTINATION_MODE_SET to value 0"]
impl crate::Resettable for DestinationModeSetSpec {
