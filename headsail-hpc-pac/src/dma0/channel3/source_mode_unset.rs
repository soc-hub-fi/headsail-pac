...
pub type W = crate::W<SOURCE_MODE_UNSET_SPEC>;
#[doc = "Field `Source_Mode_Unset` writer - "]
pub type SOURCE_MODE_UNSET_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
#[cfg(feature = "derive-debug")]
impl core::fmt::Debug for crate::generic::Reg<SOURCE_MODE_UNSET_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn source_mode_unset(&mut self) -> SOURCE_MODE_UNSET_W<SOURCE_MODE_UNSET_SPEC> {
