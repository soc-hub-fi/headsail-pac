...
pub type R = crate::R<MDIO_ADDR_ON_PHY_SPEC>;
#[doc = "Register `MDIO_ADDR_ON_PHY` writer"]
pub type W = crate::W<MDIO_ADDR_ON_PHY_SPEC>;
#[doc = "Field `MDIO_ADDR_ON_PHY` reader - "]
pub type MDIO_ADDR_ON_PHY_R = crate::FieldReader;
#[doc = "Field `MDIO_ADDR_ON_PHY` writer - "]
pub type MDIO_ADDR_ON_PHY_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdio_addr_on_phy(&mut self) -> MDIO_ADDR_ON_PHY_W<MDIO_ADDR_ON_PHY_SPEC> {
        MDIO_ADDR_ON_PHY_W::new(self, 0)
    }
}
