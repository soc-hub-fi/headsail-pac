...
pub type R = crate::R<C2cSerPllLoopCtrlSpec>;
#[doc = "Register `C2C_SER_PLL_LOOP_CTRL` writer"]
pub type W = crate::W<C2cSerPllLoopCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loop_ctrl(&mut self) -> LoopCtrlW<C2cSerPllLoopCtrlSpec> {
...
pub struct C2cSerPllLoopCtrlSpec;
impl crate::RegisterSpec for C2cSerPllLoopCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c2c_ser_pll_loop_ctrl::R`](R) reader structure"]
impl crate::Readable for C2cSerPllLoopCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`c2c_ser_pll_loop_ctrl::W`](W) writer structure"]
impl crate::Writable for C2cSerPllLoopCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets C2C_SER_PLL_LOOP_CTRL to value 0"]
impl crate::Resettable for C2cSerPllLoopCtrlSpec {
