...
pub struct C2C_PAR_PLL {
    c2c_par_pll_loop_ctrl: C2C_PAR_PLL_LOOP_CTRL,
    c2c_par_pll_div: C2C_PAR_PLL_DIV,
    c2c_par_pll_debug_ctrl: C2C_PAR_PLL_DEBUG_CTRL,
    c2c_par_pll_enable: C2C_PAR_PLL_ENABLE,
    c2c_par_pll_spare_ctrl: C2C_PAR_PLL_SPARE_CTRL,
    c2c_par_pll_tmux_sel: C2C_PAR_PLL_TMUX_SEL,
    c2c_par_pll_status1: C2C_PAR_PLL_STATUS1,
    c2c_par_pll_status2: C2C_PAR_PLL_STATUS2,
}
impl C2C_PAR_PLL {
    #[doc = "0x00 - "]
    #[inline(always)]
    pub const fn c2c_par_pll_loop_ctrl(&self) -> &C2C_PAR_PLL_LOOP_CTRL {
        &self.c2c_par_pll_loop_ctrl
    }
    #[doc = "0x04 - "]
    #[inline(always)]
    pub const fn c2c_par_pll_div(&self) -> &C2C_PAR_PLL_DIV {
        &self.c2c_par_pll_div
    }
    #[doc = "0x08 - "]
    #[inline(always)]
    pub const fn c2c_par_pll_debug_ctrl(&self) -> &C2C_PAR_PLL_DEBUG_CTRL {
        &self.c2c_par_pll_debug_ctrl
    }
    #[doc = "0x0c - "]
    #[inline(always)]
    pub const fn c2c_par_pll_enable(&self) -> &C2C_PAR_PLL_ENABLE {
        &self.c2c_par_pll_enable
    }
    #[doc = "0x10 - "]
    #[inline(always)]
    pub const fn c2c_par_pll_spare_ctrl(&self) -> &C2C_PAR_PLL_SPARE_CTRL {
        &self.c2c_par_pll_spare_ctrl
    }
    #[doc = "0x14 - "]
    #[inline(always)]
    pub const fn c2c_par_pll_tmux_sel(&self) -> &C2C_PAR_PLL_TMUX_SEL {
        &self.c2c_par_pll_tmux_sel
    }
    #[doc = "0x18 - "]
    #[inline(always)]
    pub const fn c2c_par_pll_status1(&self) -> &C2C_PAR_PLL_STATUS1 {
        &self.c2c_par_pll_status1
    }
    #[doc = "0x1c - "]
    #[inline(always)]
    pub const fn c2c_par_pll_status2(&self) -> &C2C_PAR_PLL_STATUS2 {
