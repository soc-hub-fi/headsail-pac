...
pub type R = crate::R<SpimCmdCfgSpec>;
#[doc = "Register `SPIM_CMD_CFG` writer"]
pub type W = crate::W<SpimCmdCfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn continous(&mut self) -> ContinousW<SpimCmdCfgSpec> {
        ContinousW::new(self, 0)
    }
    #[doc = "Bits 1:2 - Channel transfer size used to increment uDMA buffer address pointer: - 2'b00: +1 (8 bits) - 2'b01: +2 (16 bits) - 2'b10: +4 ("]
    #[inline(always)]
    #[must_use]
    pub fn datasize(&mut self) -> DatasizeW<SpimCmdCfgSpec> {
        DatasizeW::new(self, 1)
    }
    #[doc = "Bit 4 - Channel enable and start transfer: -1'b0: disable -1'b1: enable This signal is used also to queue a transfer if one is already ongoing"]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<SpimCmdCfgSpec> {
        EnW::new(self, 4)
    }
    #[doc = "Bit 6 - Channel clear and stop transfer: -1'b0: disable -1'b1: enable"]
    #[inline(always)]
    #[must_use]
    pub fn clr(&mut self) -> ClrW<SpimCmdCfgSpec> {
        ClrW::new(self, 6)
    }
}
...
pub struct SpimCmdCfgSpec;
impl crate::RegisterSpec for SpimCmdCfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spim_cmd_cfg::R`](R) reader structure"]
impl crate::Readable for SpimCmdCfgSpec {}
#[doc = "`write(|w| ..)` method takes [`spim_cmd_cfg::W`](W) writer structure"]
impl crate::Writable for SpimCmdCfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SPIM_CMD_CFG to value 0x04"]
impl crate::Resettable for SpimCmdCfgSpec {
