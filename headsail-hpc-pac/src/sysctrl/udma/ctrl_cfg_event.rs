...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp_evt0(&mut self) -> CMP_EVT0_W<CTRL_CFG_EVENT_SPEC> {
        CMP_EVT0_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Forward event with ID matching CMP_EVT1 to peripherals as event1"]
    #[inline(always)]
    #[must_use]
    pub fn cmp_evt1(&mut self) -> CMP_EVT1_W<CTRL_CFG_EVENT_SPEC> {
        CMP_EVT1_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Forward event with ID matching CMP_EVT2 to peripherals as event2"]
    #[inline(always)]
    #[must_use]
    pub fn cmp_evt2(&mut self) -> CMP_EVT2_W<CTRL_CFG_EVENT_SPEC> {
        CMP_EVT2_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Forward event with ID matching CMP_EVT3 to peripherals as event3"]
    #[inline(always)]
    #[must_use]
    pub fn cmp_evt3(&mut self) -> CMP_EVT3_W<CTRL_CFG_EVENT_SPEC> {
        CMP_EVT3_W::new(self, 24)
    }
}
