...
pub type R = crate::R<EthPllDebugCtrlSpec>;
#[doc = "Register `ETH_PLL_DEBUG_CTRL` writer"]
pub type W = crate::W<EthPllDebugCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn debug_ctrl(&mut self) -> DebugCtrlW<EthPllDebugCtrlSpec> {
...
pub struct EthPllDebugCtrlSpec;
impl crate::RegisterSpec for EthPllDebugCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eth_pll_debug_ctrl::R`](R) reader structure"]
impl crate::Readable for EthPllDebugCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`eth_pll_debug_ctrl::W`](W) writer structure"]
impl crate::Writable for EthPllDebugCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ETH_PLL_DEBUG_CTRL to value 0"]
impl crate::Resettable for EthPllDebugCtrlSpec {
