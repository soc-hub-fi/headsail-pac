...
pub type R = crate::R<EthPllLoopCtrlSpec>;
#[doc = "Register `ETH_PLL_LOOP_CTRL` writer"]
pub type W = crate::W<EthPllLoopCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loop_ctrl(&mut self) -> LoopCtrlW<EthPllLoopCtrlSpec> {
...
pub struct EthPllLoopCtrlSpec;
impl crate::RegisterSpec for EthPllLoopCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eth_pll_loop_ctrl::R`](R) reader structure"]
impl crate::Readable for EthPllLoopCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`eth_pll_loop_ctrl::W`](W) writer structure"]
impl crate::Writable for EthPllLoopCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ETH_PLL_LOOP_CTRL to value 0"]
impl crate::Resettable for EthPllLoopCtrlSpec {
