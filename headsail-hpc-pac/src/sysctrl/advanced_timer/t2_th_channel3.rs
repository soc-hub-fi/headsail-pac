...
pub type R = crate::R<T2ThChannel3Spec>;
#[doc = "Register `T2_TH_CHANNEL3` writer"]
pub type W = crate::W<T2ThChannel3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn th(&mut self) -> ThW<T2ThChannel3Spec> {
        ThW::new(self, 0)
    }
    #[doc = "Bits 16:18 - ADV_TIMER2 channel 3 threshold match action on channel output signal configuration bitfield: - 3'h0: set. - 3'h1: toggle then next threshold match action is clear. - 3'h2: set then next threshold match action is clear. - 3'h3: toggle. - 3'h4: clear. - 3'h5: toggle then next threshold match action is set. - 3'h6: clear then next threshold match action is set."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<T2ThChannel3Spec> {
        ModeW::new(self, 16)
    }
}
...
pub struct T2ThChannel3Spec;
impl crate::RegisterSpec for T2ThChannel3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`t2_th_channel3::R`](R) reader structure"]
impl crate::Readable for T2ThChannel3Spec {}
#[doc = "`write(|w| ..)` method takes [`t2_th_channel3::W`](W) writer structure"]
impl crate::Writable for T2ThChannel3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets T2_TH_CHANNEL3 to value 0"]
impl crate::Resettable for T2ThChannel3Spec {
