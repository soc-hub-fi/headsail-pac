...
pub type R = crate::R<T0_CMD_SPEC>;
#[doc = "Register `T0_CMD` writer"]
pub type W = crate::W<T0_CMD_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn start(&mut self) -> START_W<T0_CMD_SPEC> {
        START_W::new(self, 0)
    }
    #[doc = "Bit 1 - ADV_TIMER0 stop command bitfield."]
    #[inline(always)]
    #[must_use]
    pub fn stop(&mut self) -> STOP_W<T0_CMD_SPEC> {
        STOP_W::new(self, 1)
    }
    #[doc = "Bit 2 - ADV_TIMER0 update command bitfield."]
    #[inline(always)]
    #[must_use]
    pub fn update(&mut self) -> UPDATE_W<T0_CMD_SPEC> {
        UPDATE_W::new(self, 2)
    }
    #[doc = "Bit 3 - ADV_TIMER0 reset command bitfield"]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> RESET_W<T0_CMD_SPEC> {
        RESET_W::new(self, 3)
    }
    #[doc = "Bit 4 - ADV_TIMER0 arm command bitfield."]
    #[inline(always)]
    #[must_use]
    pub fn arm(&mut self) -> ARM_W<T0_CMD_SPEC> {
        ARM_W::new(self, 4)
    }
}
