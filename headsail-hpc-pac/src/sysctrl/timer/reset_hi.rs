...
pub type R = crate::R<RESET_HI_SPEC>;
#[doc = "Register `RESET_HI` writer"]
pub type W = crate::W<RESET_HI_SPEC>;
#[doc = "Field `RESET_HI` reader - "]
pub type RESET_HI_R = crate::BitReader;
#[doc = "Field `RESET_HI` writer - "]
pub type RESET_HI_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reset_hi(&mut self) -> RESET_HI_W<RESET_HI_SPEC> {
        RESET_HI_W::new(self, 0)
    }
}
