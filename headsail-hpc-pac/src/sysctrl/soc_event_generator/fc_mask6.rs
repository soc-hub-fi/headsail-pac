...
pub type R = crate::R<FcMask6Spec>;
#[doc = "Register `FC_MASK6` writer"]
pub type W = crate::W<FcMask6Spec>;
...
to 0b0 enables dispatching event to FC interrupt controller."]
    #[inline(always)]
    #[must_use]
    pub fn fc_mask6(&mut self) -> FcMask6W<FcMask6Spec> {
        FcMask6W::new(self, 0)
    }
}
