...
pub type R = crate::R<PR_MASK4_SPEC>;
#[doc = "Register `PR_MASK4` writer"]
pub type W = crate::W<PR_MASK4_SPEC>;
...
to 0b0 enables dispatching event to peripherals."]
    #[inline(always)]
    #[must_use]
    pub fn pr_mask4(&mut self) -> PR_MASK4_W<PR_MASK4_SPEC> {
        PR_MASK4_W::new(self, 0)
    }
}
