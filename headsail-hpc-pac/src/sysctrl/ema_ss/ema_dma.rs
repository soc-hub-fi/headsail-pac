...
pub type R = crate::R<EMA_DMA_SPEC>;
#[doc = "Register `EMA_DMA` writer"]
pub type W = crate::W<EMA_DMA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dpram_ema(&mut self) -> DPRAM_EMA_W<EMA_DMA_SPEC> {
        DPRAM_EMA_W::new(self, 0)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    #[must_use]
    pub fn spram_ema(&mut self) -> SPRAM_EMA_W<EMA_DMA_SPEC> {
