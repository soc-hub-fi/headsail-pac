...
pub type R = crate::R<DLA_PLL_DIV_SPEC>;
#[doc = "Register `DLA_PLL_DIV` writer"]
pub type W = crate::W<DLA_PLL_DIV_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn r_div(&mut self) -> R_DIV_W<DLA_PLL_DIV_SPEC> {
        R_DIV_W::new(self, 0)
    }
    #[doc = "Bits 4:13"]
    #[inline(always)]
    #[must_use]
    pub fn n_div(&mut self) -> N_DIV_W<DLA_PLL_DIV_SPEC> {
        N_DIV_W::new(self, 4)
    }
    #[doc = "Bits 14:16"]
    #[inline(always)]
    #[must_use]
    pub fn m_div(&mut self) -> M_DIV_W<DLA_PLL_DIV_SPEC> {
        M_DIV_W::new(self, 14)
    }
}
