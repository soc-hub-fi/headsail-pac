...
pub type R = crate::R<IcnPllDivSpec>;
#[doc = "Register `ICN_PLL_DIV` writer"]
pub type W = crate::W<IcnPllDivSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn r_div(&mut self) -> RDivW<IcnPllDivSpec> {
        RDivW::new(self, 0)
    }
    #[doc = "Bits 4:13"]
    #[inline(always)]
    #[must_use]
    pub fn n_div(&mut self) -> NDivW<IcnPllDivSpec> {
        NDivW::new(self, 4)
    }
    #[doc = "Bits 14:16"]
    #[inline(always)]
    #[must_use]
    pub fn m_div(&mut self) -> MDivW<IcnPllDivSpec> {
        MDivW::new(self, 14)
    }
}
...
pub struct IcnPllDivSpec;
impl crate::RegisterSpec for IcnPllDivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`icn_pll_div::R`](R) reader structure"]
impl crate::Readable for IcnPllDivSpec {}
#[doc = "`write(|w| ..)` method takes [`icn_pll_div::W`](W) writer structure"]
impl crate::Writable for IcnPllDivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ICN_PLL_DIV to value 0"]
impl crate::Resettable for IcnPllDivSpec {
