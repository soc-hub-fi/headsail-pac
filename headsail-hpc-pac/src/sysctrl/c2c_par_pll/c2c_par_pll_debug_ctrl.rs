...
pub type R = crate::R<C2C_PAR_PLL_DEBUG_CTRL_SPEC>;
#[doc = "Register `C2C_PAR_PLL_DEBUG_CTRL` writer"]
pub type W = crate::W<C2C_PAR_PLL_DEBUG_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn debug_ctrl(&mut self) -> DEBUG_CTRL_W<C2C_PAR_PLL_DEBUG_CTRL_SPEC> {
