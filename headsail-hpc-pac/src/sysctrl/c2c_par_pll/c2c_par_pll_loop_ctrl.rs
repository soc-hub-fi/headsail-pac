...
pub type R = crate::R<C2C_PAR_PLL_LOOP_CTRL_SPEC>;
#[doc = "Register `C2C_PAR_PLL_LOOP_CTRL` writer"]
pub type W = crate::W<C2C_PAR_PLL_LOOP_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loop_ctrl(&mut self) -> LOOP_CTRL_W<C2C_PAR_PLL_LOOP_CTRL_SPEC> {
