...
pub struct PLIC {
    base: BASE,
    timer0_prio: [TIMER0_PRIO; 2],
    timer1_prio: [TIMER1_PRIO; 2],
    timer2_prio: [TIMER2_PRIO; 2],
    timer3_prio: [TIMER3_PRIO; 2],
    ext_prio: [EXT_PRIO; 23],
    _reserved6: [u8; 0x1f80],
    irq_enable: [IRQ_ENABLE; 8],
    _reserved7: [u8; 0x1fe0],
    prio_thr_0: PRIO_THR_0,
    claim_complete_0: CLAIM_COMPLETE_0,
    _reserved9: [u8; 0x0ff8],
    prio_thr_1: PRIO_THR_1,
    claim_complete_1: CLAIM_COMPLETE_1,
    _reserved11: [u8; 0x0ff8],
    prio_thr_2: PRIO_THR_2,
    claim_complete_2: CLAIM_COMPLETE_2,
    _reserved13: [u8; 0x0ff8],
    prio_thr_3: PRIO_THR_3,
    claim_complete_3: CLAIM_COMPLETE_3,
    _reserved15: [u8; 0x0ff8],
    prio_thr_4: PRIO_THR_4,
    claim_complete_4: CLAIM_COMPLETE_4,
    _reserved17: [u8; 0x0ff8],
    prio_thr_5: PRIO_THR_5,
    claim_complete_5: CLAIM_COMPLETE_5,
    _reserved19: [u8; 0x0ff8],
    prio_thr_6: PRIO_THR_6,
    claim_complete_6: CLAIM_COMPLETE_6,
    _reserved21: [u8; 0x0ff8],
    prio_thr_7: PRIO_THR_7,
    claim_complete_7: CLAIM_COMPLETE_7,
}
impl PLIC {
    #[doc = "0x00 - Reserved"]
    #[inline(always)]
...
(timer overflow interrupt). Max priority is 7."]
    #[inline(always)]
    pub const fn timer0_prio(&self, n: usize) -> &TIMER0_PRIO {
        &self.timer0_prio[n]
    }
...
(timer overflow interrupt). Max priority is 7."]
    #[inline(always)]
    pub fn timer0_prio_iter(&self) -> impl Iterator<Item = &TIMER0_PRIO> {
        self.timer0_prio.iter()
    }
    #[doc = "0x0c..0x14 - Interrupt priority for timer 1 interrupt \\[%s\\]
(timer overflow interrupt). Max priority is 7."]
    #[inline(always)]
    pub const fn timer1_prio(&self, n: usize) -> &TIMER1_PRIO {
        &self.timer1_prio[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x0c..0x14 - Interrupt priority for timer 1 interrupt \\[%s\\]
(timer overflow interrupt). Max priority is 7."]
    #[inline(always)]
    pub fn timer1_prio_iter(&self) -> impl Iterator<Item = &TIMER1_PRIO> {
        self.timer1_prio.iter()
    }
    #[doc = "0x14..0x1c - Interrupt priority for timer 2 interrupt \\[%s\\]
(timer overflow interrupt). Max priority is 7."]
    #[inline(always)]
    pub const fn timer2_prio(&self, n: usize) -> &TIMER2_PRIO {
        &self.timer2_prio[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x14..0x1c - Interrupt priority for timer 2 interrupt \\[%s\\]
(timer overflow interrupt). Max priority is 7."]
    #[inline(always)]
    pub fn timer2_prio_iter(&self) -> impl Iterator<Item = &TIMER2_PRIO> {
        self.timer2_prio.iter()
    }
    #[doc = "0x1c..0x24 - Interrupt priority for timer 3 interrupt \\[%s\\]
(timer overflow interrupt). Max priority is 7."]
    #[inline(always)]
    pub const fn timer3_prio(&self, n: usize) -> &TIMER3_PRIO {
        &self.timer3_prio[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x1c..0x24 - Interrupt priority for timer 3 interrupt \\[%s\\]
(timer overflow interrupt). Max priority is 7."]
    #[inline(always)]
    pub fn timer3_prio_iter(&self) -> impl Iterator<Item = &TIMER3_PRIO> {
        self.timer3_prio.iter()
    }
    #[doc = "0x24..0x80 - Interrupt priority for external interrupt \\[%s\\]"]
    #[inline(always)]
    pub const fn ext_prio(&self, n: usize) -> &EXT_PRIO {
        &self.ext_prio[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x24..0x80 - Interrupt priority for external interrupt \\[%s\\]"]
    #[inline(always)]
    pub fn ext_prio_iter(&self) -> impl Iterator<Item = &EXT_PRIO> {
        self.ext_prio.iter()
    }
    #[doc = "0x2000..0x2020 - IRQ enable bits for Hart context #\\[%s\\]. `idx / 2` is core-#. Even indices are M-mode, odd indices are S-mode."]
    #[inline(always)]
    pub const fn irq_enable(&self, n: usize) -> &IRQ_ENABLE {
        &self.irq_enable[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x2000..0x2020 - IRQ enable bits for Hart context #\\[%s\\]. `idx / 2` is core-#. Even indices are M-mode, odd indices are S-mode."]
    #[inline(always)]
    pub fn irq_enable_iter(&self) -> impl Iterator<Item = &IRQ_ENABLE> {
    ...
    #[inline(always)]
    pub const fn prio_thr_0(&self) -> &PRIO_THR_0 {
        &self.prio_thr_0
    }
    ...
    #[inline(always)]
    pub const fn claim_complete_0(&self) -> &CLAIM_COMPLETE_0 {
    ...
    #[inline(always)]
    pub const fn prio_thr_1(&self) -> &PRIO_THR_1 {
        &self.prio_thr_1
    }
    ...
    #[inline(always)]
    pub const fn claim_complete_1(&self) -> &CLAIM_COMPLETE_1 {
    ...
    #[inline(always)]
    pub const fn prio_thr_2(&self) -> &PRIO_THR_2 {
        &self.prio_thr_2
    }
    ...
    #[inline(always)]
    pub const fn claim_complete_2(&self) -> &CLAIM_COMPLETE_2 {
    ...
    #[inline(always)]
    pub const fn prio_thr_3(&self) -> &PRIO_THR_3 {
        &self.prio_thr_3
    }
    ...
    #[inline(always)]
    pub const fn claim_complete_3(&self) -> &CLAIM_COMPLETE_3 {
    ...
    #[inline(always)]
    pub const fn prio_thr_4(&self) -> &PRIO_THR_4 {
        &self.prio_thr_4
    }
    ...
    #[inline(always)]
    pub const fn claim_complete_4(&self) -> &CLAIM_COMPLETE_4 {
    ...
    #[inline(always)]
    pub const fn prio_thr_6(&self) -> &PRIO_THR_6 {
        &self.prio_thr_6
    }
    ...
    #[inline(always)]
    pub const fn claim_complete_6(&self) -> &CLAIM_COMPLETE_6 {
    ...
    #[inline(always)]
    pub const fn prio_thr_7(&self) -> &PRIO_THR_7 {
        &self.prio_thr_7
    }
    ...
    #[inline(always)]
    pub const fn claim_complete_7(&self) -> &CLAIM_COMPLETE_7 {
