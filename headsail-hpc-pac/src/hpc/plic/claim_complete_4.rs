...
pub type R = crate::R<ClaimComplete4Spec>;
#[doc = "Register `claim_complete_4` writer"]
pub type W = crate::W<ClaimComplete4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn claim_complete(&mut self) -> ClaimCompleteW<ClaimComplete4Spec> {
...
pub struct ClaimComplete4Spec;
impl crate::RegisterSpec for ClaimComplete4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`claim_complete_4::R`](R) reader structure"]
impl crate::Readable for ClaimComplete4Spec {}
#[doc = "`write(|w| ..)` method takes [`claim_complete_4::W`](W) writer structure"]
impl crate::Writable for ClaimComplete4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets claim_complete_4 to value 0"]
impl crate::Resettable for ClaimComplete4Spec {
