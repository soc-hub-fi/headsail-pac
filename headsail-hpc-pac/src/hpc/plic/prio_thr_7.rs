...
pub type R = crate::R<PrioThr7Spec>;
#[doc = "Register `prio_thr_7` writer"]
pub type W = crate::W<PrioThr7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn thr(&mut self) -> ThrW<PrioThr7Spec> {
        ThrW::new(self, 0)
    }
}
...
pub struct PrioThr7Spec;
impl crate::RegisterSpec for PrioThr7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`prio_thr_7::R`](R) reader structure"]
impl crate::Readable for PrioThr7Spec {}
#[doc = "`write(|w| ..)` method takes [`prio_thr_7::W`](W) writer structure"]
impl crate::Writable for PrioThr7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets prio_thr_7 to value 0"]
impl crate::Resettable for PrioThr7Spec {
