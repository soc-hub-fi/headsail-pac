...
pub type R = crate::R<CACHED_REGION_ADDR_BASE0_SPEC>;
#[doc = "Register `cached_region_addr_base0` writer"]
pub type W = crate::W<CACHED_REGION_ADDR_BASE0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn base(&mut self) -> BASE_W<CACHED_REGION_ADDR_BASE0_SPEC> {
        BASE_W::new(self, 0)
    }
}
