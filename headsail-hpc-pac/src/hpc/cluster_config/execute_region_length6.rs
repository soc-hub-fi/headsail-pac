...
pub type R = crate::R<EXECUTE_REGION_LENGTH6_SPEC>;
#[doc = "Register `execute_region_length6` writer"]
pub type W = crate::W<EXECUTE_REGION_LENGTH6_SPEC>;
#[doc = "Field `len_0` reader - "]
pub type LEN_0_R = crate::FieldReader<u64>;
#[doc = "Field `len_0` writer - "]
pub type LEN_0_W<'a, REG> = crate::FieldWriter<'a, REG, 64, u64>;
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn len_0(&mut self) -> LEN_0_W<EXECUTE_REGION_LENGTH6_SPEC> {
        LEN_0_W::new(self, 0)
    }
}
