...
pub type R = crate::R<ClusterConfigBaseSpec>;
#[doc = "Register `cluster_config_base` writer"]
pub type W = crate::W<ClusterConfigBaseSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn base(&mut self) -> BaseW<ClusterConfigBaseSpec> {
        BaseW::new(self, 0)
    }
}
...
pub struct ClusterConfigBaseSpec;
impl crate::RegisterSpec for ClusterConfigBaseSpec {
    type Ux = u64;
}
#[doc = "`read()` method returns [`cluster_config_base::R`](R) reader structure"]
impl crate::Readable for ClusterConfigBaseSpec {}
#[doc = "`write(|w| ..)` method takes [`cluster_config_base::W`](W) writer structure"]
impl crate::Writable for ClusterConfigBaseSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
}
#[doc = "`reset()` method sets cluster_config_base to value 0x0005_4000"]
impl crate::Resettable for ClusterConfigBaseSpec {
