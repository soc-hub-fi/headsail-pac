...
pub type R = crate::R<TimerBaseSpec>;
#[doc = "Register `timer_base` writer"]
pub type W = crate::W<TimerBaseSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn base(&mut self) -> BaseW<TimerBaseSpec> {
        BaseW::new(self, 0)
    }
}
