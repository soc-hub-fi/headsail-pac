...
pub type R = crate::R<Timer3CmpSpec>;
#[doc = "Register `timer3_cmp` writer"]
pub type W = crate::W<Timer3CmpSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp(&mut self) -> CmpW<Timer3CmpSpec> {
        CmpW::new(self, 0)
    }
}
...
pub struct Timer3CmpSpec;
impl crate::RegisterSpec for Timer3CmpSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer3_cmp::R`](R) reader structure"]
impl crate::Readable for Timer3CmpSpec {}
#[doc = "`write(|w| ..)` method takes [`timer3_cmp::W`](W) writer structure"]
impl crate::Writable for Timer3CmpSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets timer3_cmp to value 0"]
impl crate::Resettable for Timer3CmpSpec {
