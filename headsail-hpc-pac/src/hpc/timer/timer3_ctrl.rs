...
pub type R = crate::R<TIMER3_CTRL_SPEC>;
#[doc = "Register `timer3_ctrl` writer"]
pub type W = crate::W<TIMER3_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<TIMER3_CTRL_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bits 3:5 - Prescaler bits"]
    #[inline(always)]
    #[must_use]
    pub fn prescaler(&mut self) -> PRESCALER_W<TIMER3_CTRL_SPEC> {
