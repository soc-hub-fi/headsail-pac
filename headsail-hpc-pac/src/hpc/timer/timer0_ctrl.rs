...
pub type R = crate::R<TIMER0_CTRL_SPEC>;
#[doc = "Register `timer0_ctrl` writer"]
pub type W = crate::W<TIMER0_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<TIMER0_CTRL_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bits 3:5 - Prescaler bits"]
    #[inline(always)]
    #[must_use]
    pub fn prescaler(&mut self) -> PRESCALER_W<TIMER0_CTRL_SPEC> {
