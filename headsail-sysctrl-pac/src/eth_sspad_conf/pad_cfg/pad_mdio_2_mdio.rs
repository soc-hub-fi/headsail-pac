#[doc = "Register `PAD_MDIO_2_MDIO` reader"]
pub struct R(crate::R<PAD_MDIO_2_MDIO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PAD_MDIO_2_MDIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PAD_MDIO_2_MDIO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PAD_MDIO_2_MDIO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PAD_MDIO_2_MDIO` writer"]
pub struct W(crate::W<PAD_MDIO_2_MDIO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PAD_MDIO_2_MDIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PAD_MDIO_2_MDIO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PAD_MDIO_2_MDIO_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DS0_W<'a, const O: u8> = crate::BitWriter<'a, u32, PAD_MDIO_2_MDIO_SPEC, DS0_A, O>;
...
pub type DS1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PAD_MDIO_2_MDIO_SPEC, DS1_A, O>;
...
pub type ST0_W<'a, const O: u8> = crate::BitWriter<'a, u32, PAD_MDIO_2_MDIO_SPEC, ST0_A, O>;
...
pub type ST1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PAD_MDIO_2_MDIO_SPEC, ST1_A, O>;
...
pub type RATE_CONTROL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PAD_MDIO_2_MDIO_SPEC, RATE_CONTROL_A, O>;
...
pub type HOLD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PAD_MDIO_2_MDIO_SPEC, HOLD_A, O>;
...
pub type PULL_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PAD_MDIO_2_MDIO_SPEC, PULL_ENABLE_A, O>;
...
pub type PULL_DIR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PAD_MDIO_2_MDIO_SPEC, PULL_DIR_A, O>;
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pad_mdio_2_mdio](index.html) module"]
pub struct PAD_MDIO_2_MDIO_SPEC;
impl crate::RegisterSpec for PAD_MDIO_2_MDIO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pad_mdio_2_mdio::R](R) reader structure"]
impl crate::Readable for PAD_MDIO_2_MDIO_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pad_mdio_2_mdio::W](W) writer structure"]
impl crate::Writable for PAD_MDIO_2_MDIO_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PAD_MDIO_2_MDIO to value 0x0235"]
impl crate::Resettable for PAD_MDIO_2_MDIO_SPEC {
    const RESET_VALUE: Self::Ux = 0x0235;
}
