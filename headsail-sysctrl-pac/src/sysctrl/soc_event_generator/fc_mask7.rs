...
pub type R = crate::R<FcMask7Spec>;
#[doc = "Register `FC_MASK7` writer"]
pub type W = crate::W<FcMask7Spec>;
...
to 0b0 enables dispatching event to FC interrupt controller."]
    #[inline(always)]
    #[must_use]
    pub fn fc_mask7(&mut self) -> FcMask7W<FcMask7Spec> {
        FcMask7W::new(self, 0)
    }
}
