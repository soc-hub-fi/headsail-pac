...
pub struct W(crate::W<SW_EVENT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SW_EVENT_SPEC>;
    #[inline(always)]
...
impl From<crate::W<SW_EVENT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SW_EVENT_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `EVENT` writer - Writing a one-hot value into EVENT triggers a SoC software event. 8 software events are available."]
pub type EVENT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SW_EVENT_SPEC, u8, u8, 8, O>;
impl W {
