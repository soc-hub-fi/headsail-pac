...
pub type R = crate::R<PR_MASK7_SPEC>;
#[doc = "Register `PR_MASK7` writer"]
pub type W = crate::W<PR_MASK7_SPEC>;
...
to 0b0 enables dispatching event to peripherals."]
    #[inline(always)]
    #[must_use]
    pub fn pr_mask7(&mut self) -> PR_MASK7_W<PR_MASK7_SPEC> {
        PR_MASK7_W::new(self, 0)
    }
}
