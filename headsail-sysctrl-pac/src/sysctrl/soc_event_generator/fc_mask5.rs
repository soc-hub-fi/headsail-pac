...
pub type R = crate::R<FC_MASK5_SPEC>;
#[doc = "Register `FC_MASK5` writer"]
pub type W = crate::W<FC_MASK5_SPEC>;
...
to 0b0 enables dispatching event to FC interrupt controller."]
    #[inline(always)]
    #[must_use]
    pub fn fc_mask5(&mut self) -> FC_MASK5_W<FC_MASK5_SPEC> {
        FC_MASK5_W::new(self, 0)
    }
}
