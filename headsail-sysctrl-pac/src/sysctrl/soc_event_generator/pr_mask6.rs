...
pub type R = crate::R<PR_MASK6_SPEC>;
#[doc = "Register `PR_MASK6` writer"]
pub type W = crate::W<PR_MASK6_SPEC>;
...
to 0b0 enables dispatching event to peripherals."]
    #[inline(always)]
    #[must_use]
    pub fn pr_mask6(&mut self) -> PR_MASK6_W<PR_MASK6_SPEC> {
        PR_MASK6_W::new(self, 0)
    }
}
