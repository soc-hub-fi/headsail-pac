...
pub type R = crate::R<FC_MASK1_SPEC>;
#[doc = "Register `FC_MASK1` writer"]
pub type W = crate::W<FC_MASK1_SPEC>;
...
to 0b0 enables dispatching event to FC interrupt controller."]
    #[inline(always)]
    #[must_use]
    pub fn fc_mask1(&mut self) -> FC_MASK1_W<FC_MASK1_SPEC> {
        FC_MASK1_W::new(self, 0)
    }
}
