...
pub type R = crate::R<PrMask0Spec>;
#[doc = "Register `PR_MASK0` writer"]
pub type W = crate::W<PrMask0Spec>;
#[doc = "Field `PR_MASK0` reader - "]
pub type PrMask0R = crate::FieldReader<u32>;
#[doc = "Field `PR_MASK0` writer - "]
pub type PrMask0W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn pr_mask0(&self) -> PrMask0R {
        PrMask0R::new(self.bits)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pr_mask0(&mut self) -> PrMask0W<PrMask0Spec> {
        PrMask0W::new(self, 0)
    }
}
