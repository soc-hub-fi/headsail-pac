...
pub type R = crate::R<FC_MASK4_SPEC>;
#[doc = "Register `FC_MASK4` writer"]
pub type W = crate::W<FC_MASK4_SPEC>;
...
to 0b0 enables dispatching event to FC interrupt controller."]
    #[inline(always)]
    #[must_use]
    pub fn fc_mask4(&mut self) -> FC_MASK4_W<FC_MASK4_SPEC> {
        FC_MASK4_W::new(self, 0)
    }
}
