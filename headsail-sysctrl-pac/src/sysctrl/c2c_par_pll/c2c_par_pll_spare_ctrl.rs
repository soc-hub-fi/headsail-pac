...
pub type R = crate::R<C2cParPllSpareCtrlSpec>;
#[doc = "Register `C2C_PAR_PLL_SPARE_CTRL` writer"]
pub type W = crate::W<C2cParPllSpareCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spare_ctrl(&mut self) -> SpareCtrlW<C2cParPllSpareCtrlSpec> {
...
pub struct C2cParPllSpareCtrlSpec;
impl crate::RegisterSpec for C2cParPllSpareCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c2c_par_pll_spare_ctrl::R`](R) reader structure"]
impl crate::Readable for C2cParPllSpareCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`c2c_par_pll_spare_ctrl::W`](W) writer structure"]
impl crate::Writable for C2cParPllSpareCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets C2C_PAR_PLL_SPARE_CTRL to value 0"]
impl crate::Resettable for C2cParPllSpareCtrlSpec {
