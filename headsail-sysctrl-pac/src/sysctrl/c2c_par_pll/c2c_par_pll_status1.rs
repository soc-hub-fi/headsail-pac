...
pub struct R(crate::R<C2C_PAR_PLL_STATUS1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C2C_PAR_PLL_STATUS1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C2C_PAR_PLL_STATUS1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C2C_PAR_PLL_STATUS1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c2c_par_pll_status1](index.html) module"]
