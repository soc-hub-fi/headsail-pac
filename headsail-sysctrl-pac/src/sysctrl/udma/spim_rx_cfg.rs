...
pub type R = crate::R<SpimRxCfgSpec>;
#[doc = "Register `SPIM_RX_CFG` writer"]
pub type W = crate::W<SpimRxCfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn continous(&mut self) -> ContinousW<SpimRxCfgSpec> {
        ContinousW::new(self, 0)
    }
    #[doc = "Bits 1:2 - Channel transfer size used to increment uDMA buffer address pointer: - 2'b00: +1 (8 bits) - 2'b01: +2 (16 bits) - 2'b10: +4 ("]
    #[inline(always)]
    #[must_use]
    pub fn datasize(&mut self) -> DatasizeW<SpimRxCfgSpec> {
        DatasizeW::new(self, 1)
    }
    #[doc = "Bit 4 - Channel enable and start transfer: -1'b0: disable -1'b1: enable This signal is used also to queue a transfer if one is already ongoing"]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<SpimRxCfgSpec> {
        EnW::new(self, 4)
    }
    #[doc = "Bit 6 - Channel clear and stop transfer: -1'b0: disable -1'b1: enable"]
    #[inline(always)]
    #[must_use]
    pub fn clr(&mut self) -> ClrW<SpimRxCfgSpec> {
        ClrW::new(self, 6)
    }
}
