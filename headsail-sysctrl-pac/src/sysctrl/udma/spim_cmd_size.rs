...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmd_size(&mut self) -> CMD_SIZE_W<SPIM_CMD_SIZE_SPEC> {
        CMD_SIZE_W::new(self, 0)
    }
}
