...
pub type REG_RX_CH_ADD_R = crate::FieldReader<u32, u32>;
#[doc = "Field `REG_RX_CH_ADD` writer - "]
pub type REG_RX_CH_ADD_W<'a, const O: u8> =
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_rx_ch_add(&mut self) -> REG_RX_CH_ADD_W<0> {
        REG_RX_CH_ADD_W::new(self)
    }
