...
pub type REG_TX_CH0_LEN2_R = crate::FieldReader<u32, u32>;
#[doc = "Field `REG_TX_CH0_LEN2` writer - "]
pub type REG_TX_CH0_LEN2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_CH0_LEN2_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_tx_ch0_len2(&mut self) -> REG_TX_CH0_LEN2_W<0> {
        REG_TX_CH0_LEN2_W::new(self)
    }
