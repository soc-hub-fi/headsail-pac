...
pub type R = crate::R<UART_TX_CFG_SPEC>;
#[doc = "Register `UART_TX_CFG` writer"]
pub type W = crate::W<UART_TX_CFG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn continous(&mut self) -> CONTINOUS_W<UART_TX_CFG_SPEC> {
        CONTINOUS_W::new(self, 0)
    }
    #[doc = "Bit 4 - TX channel enable and start transfer bitfield: -1'b0: disabled -1'b1: enable and start the transfer This signal is used also to queue a transfer if one is already ongoing."]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<UART_TX_CFG_SPEC> {
        EN_W::new(self, 4)
    }
    #[doc = "Bit 6 - RX channel clear and stop transfer: -1'b0: disable -1'b1: stop and clear the on-going transfer"]
    #[inline(always)]
    #[must_use]
    pub fn clr(&mut self) -> CLR_W<UART_TX_CFG_SPEC> {
        CLR_W::new(self, 6)
    }
}
