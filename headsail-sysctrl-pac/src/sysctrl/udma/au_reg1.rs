...
pub type REG_AU_REG1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `REG_AU_REG1` writer - "]
pub type REG_AU_REG1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AU_REG1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_au_reg1(&mut self) -> REG_AU_REG1_W<0> {
        REG_AU_REG1_W::new(self)
    }
