...
#[doc = "Field `REG_TX_CH0_LEN1` reader - "]
pub type REG_TX_CH0_LEN1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `REG_TX_CH0_LEN1` writer - "]
pub type REG_TX_CH0_LEN1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_CH0_LEN1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_tx_ch0_len1(&self) -> REG_TX_CH0_LEN1_R {
        REG_TX_CH0_LEN1_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    #[must_use]
    pub fn reg_tx_ch0_len1(&mut self) -> REG_TX_CH0_LEN1_W<0> {
        REG_TX_CH0_LEN1_W::new(self)
    }
