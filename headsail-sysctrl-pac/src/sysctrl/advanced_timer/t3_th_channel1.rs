...
pub type R = crate::R<T3_TH_CHANNEL1_SPEC>;
#[doc = "Register `T3_TH_CHANNEL1` writer"]
pub type W = crate::W<T3_TH_CHANNEL1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn th(&mut self) -> TH_W<T3_TH_CHANNEL1_SPEC> {
        TH_W::new(self, 0)
    }
    #[doc = "Bits 16:18 - ADV_TIMER3 channel 1 threshold match action on channel output signal configuration bitfield: - 3'h0: set. - 3'h1: toggle then next threshold match action is clear. - 3'h2: set then next threshold match action is clear. - 3'h3: toggle. - 3'h4: clear. - 3'h5: toggle then next threshold match action is set. - 3'h6: clear then next threshold match action is set."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> MODE_W<T3_TH_CHANNEL1_SPEC> {
        MODE_W::new(self, 16)
    }
}
#[doc = "ADV_TIMER3 channel 1 threshold configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`t3_th_channel1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`t3_th_channel1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
