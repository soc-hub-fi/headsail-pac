...
pub struct R(crate::R<T1_CMD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<T1_CMD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<T1_CMD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<T1_CMD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `T1_CMD` writer"]
pub struct W(crate::W<T1_CMD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<T1_CMD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<T1_CMD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<T1_CMD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type START_W<'a, const O: u8> = crate::BitWriter<'a, u32, T1_CMD_SPEC, bool, O>;
...
pub type STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, T1_CMD_SPEC, bool, O>;
...
pub type UPDATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, T1_CMD_SPEC, bool, O>;
...
pub type RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, T1_CMD_SPEC, bool, O>;
...
pub type ARM_W<'a, const O: u8> = crate::BitWriter<'a, u32, T1_CMD_SPEC, bool, O>;
impl R {
