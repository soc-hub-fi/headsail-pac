...
to GPIO\\[31\\]
- 32-35: Channel 0 to 3 of ADV_TIMER0 - 36-39: Channel 0 to 3 of ADV_TIMER1 - 40-43: Channel 0 to 3 of ADV_TIMER2 - 44-47: Channel 0 to 3 of ADV_TIMER3"]
pub type INSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T3_CONFIG_SPEC, u8, u8, 8, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T3_CONFIG_SPEC, u8, u8, 3, O>;
...
pub type CLKSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, T3_CONFIG_SPEC, bool, O>;
...
pub type UPDOWNSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, T3_CONFIG_SPEC, bool, O>;
...
pub type PRESC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T3_CONFIG_SPEC, u8, u8, 8, O>;
impl R {
