...
pub struct R(crate::R<T1_CONFIG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<T1_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<T1_CONFIG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<T1_CONFIG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `T1_CONFIG` writer"]
pub struct W(crate::W<T1_CONFIG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<T1_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<T1_CONFIG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<T1_CONFIG_SPEC>) -> Self {
        W(writer)
    }
}
