...
pub struct R(crate::R<T3_THRESHOLD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<T3_THRESHOLD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<T3_THRESHOLD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<T3_THRESHOLD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `T3_THRESHOLD` writer"]
pub struct W(crate::W<T3_THRESHOLD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<T3_THRESHOLD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<T3_THRESHOLD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<T3_THRESHOLD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TH_LO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T3_THRESHOLD_SPEC, u16, u16, 16, O>;
...
pub type TH_HI_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T3_THRESHOLD_SPEC, u16, u16, 16, O>;
impl R {
