...
pub type R = crate::R<T2ThresholdSpec>;
#[doc = "Register `T2_THRESHOLD` writer"]
pub type W = crate::W<T2ThresholdSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn th_lo(&mut self) -> ThLoW<T2ThresholdSpec> {
        ThLoW::new(self, 0)
    }
    #[doc = "Bits 16:31 - ADV_TIMER2 threshold high part configuration bitfield. It defines end counter value."]
    #[inline(always)]
    #[must_use]
    pub fn th_hi(&mut self) -> ThHiW<T2ThresholdSpec> {
        ThHiW::new(self, 16)
    }
}
...
pub struct T2ThresholdSpec;
impl crate::RegisterSpec for T2ThresholdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`t2_threshold::R`](R) reader structure"]
impl crate::Readable for T2ThresholdSpec {}
#[doc = "`write(|w| ..)` method takes [`t2_threshold::W`](W) writer structure"]
impl crate::Writable for T2ThresholdSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets T2_THRESHOLD to value 0"]
impl crate::Resettable for T2ThresholdSpec {
