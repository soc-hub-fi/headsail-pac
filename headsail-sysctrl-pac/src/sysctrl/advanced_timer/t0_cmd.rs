...
pub struct R(crate::R<T0_CMD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<T0_CMD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<T0_CMD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<T0_CMD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `T0_CMD` writer"]
pub struct W(crate::W<T0_CMD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<T0_CMD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<T0_CMD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<T0_CMD_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "ADV_TIMER0 command register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [t0_cmd](index.html) module"]
pub struct T0_CMD_SPEC;
impl crate::RegisterSpec for T0_CMD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [t0_cmd::R](R) reader structure"]
impl crate::Readable for T0_CMD_SPEC {
    type Reader = R;
}
