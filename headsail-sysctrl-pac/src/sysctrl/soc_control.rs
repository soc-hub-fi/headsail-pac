...
pub struct SOC_CONTROL {
    ...
    #[doc = "0x38 - Clock divider ratio for the 3 Interconnect modules"]
    ...
    #[doc = "0x98 - Subsystem Clock selection. Bit definition for Ethernet, DLA; HPC, DDR2 *_CLK_CTRL Bitfield definitions \\[bit\\]:\\[field\\]
0: sel_cka 1: force_cka 2: force_ckb 3: subsys_clkena 4: - 5: - 6: - 7: pll_ctrl_valid"]
    pub clk_ctrl1: CLK_CTRL1,
    #[doc = "0x9c - Subsystem Clock selection. Bit definition for DSP, Interconnect, C2C Serial and C2C Parallel. *_CLK_CTRL Bitfield definitions \\[bit\\]:\\[field\\]
0: sel_cka 1: force_cka 2: force_ckb 3: subsys_clkena 4: - 5: - 6: - 7: pll_ctrl_valid"]
    ...
    _reserved24: [u8; 0x04],
    #[doc = "0xb8 - Subsystem Clock selection for PERIPH *_CLK_CTRL Bitfield definitions \\[bit\\]:\\[field\\]
0: sel_cka 1: force_cka 2: force_ckb 3: subsys_clkena 4: - 5: - 6: - 7: pll_ctrl_valid"]
