...
pub type LPICN_DIV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INTER_CLK_DIV_SPEC, u8, u8, 8, O>;
#[doc = "Field `HPCICN_DIV` reader - "]
pub type HPCICN_DIV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `HPCICN_DIV` writer - "]
pub type HPCICN_DIV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INTER_CLK_DIV_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
    ...
    #[doc = "Bits 16:23"]
    #[inline(always)]
    pub fn hpcicn_div(&self) -> HPCICN_DIV_R {
        HPCICN_DIV_R::new(((self.bits >> 16) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn hpcicn_div(&mut self) -> HPCICN_DIV_W<16> {
        HPCICN_DIV_W::new(self)
    }
