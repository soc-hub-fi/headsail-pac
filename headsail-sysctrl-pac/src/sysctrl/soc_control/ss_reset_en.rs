...
pub type PULPISSIMO_W<'a, const O: u8> = crate::BitWriter<'a, u32, SS_RESET_EN_SPEC, bool, O>;
...
pub type INTERCONNECT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SS_RESET_EN_SPEC, bool, O>;
...
pub type TOP_PERIPHERAL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SS_RESET_EN_SPEC, bool, O>;
#[doc = "Field `c2c` reader - C2C reset enable"]
pub type C2C_R = crate::BitReader<bool>;
#[doc = "Field `c2c` writer - C2C reset enable"]
pub type C2C_W<'a, const O: u8> = crate::BitWriter<'a, u32, SS_RESET_EN_SPEC, bool, O>;
...
pub type CORE_HW_W<'a, const O: u8> = crate::BitWriter<'a, u32, SS_RESET_EN_SPEC, bool, O>;
#[doc = "Field `TTA` reader - TTA Reset enable"]
pub type TTA_R = crate::BitReader<bool>;
#[doc = "Field `TTA` writer - TTA Reset enable"]
pub type TTA_W<'a, const O: u8> = crate::BitWriter<'a, u32, SS_RESET_EN_SPEC, bool, O>;
...
pub type ETHERNET_W<'a, const O: u8> = crate::BitWriter<'a, u32, SS_RESET_EN_SPEC, bool, O>;
...
pub type AI_W<'a, const O: u8> = crate::BitWriter<'a, u32, SS_RESET_EN_SPEC, bool, O>;
...
pub type HPC_W<'a, const O: u8> = crate::BitWriter<'a, u32, SS_RESET_EN_SPEC, bool, O>;
impl R {
