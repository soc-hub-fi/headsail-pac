...
pub type R = crate::R<HPC_PLL_TMUX_SEL_SPEC>;
#[doc = "Register `HPC_PLL_TMUX_SEL` writer"]
pub type W = crate::W<HPC_PLL_TMUX_SEL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmux_1(&mut self) -> TMUX_1_W<HPC_PLL_TMUX_SEL_SPEC> {
        TMUX_1_W::new(self, 0)
    }
    #[doc = "Bits 4:7"]
    #[inline(always)]
    #[must_use]
    pub fn tmux_2(&mut self) -> TMUX_2_W<HPC_PLL_TMUX_SEL_SPEC> {
        TMUX_2_W::new(self, 4)
    }
}
