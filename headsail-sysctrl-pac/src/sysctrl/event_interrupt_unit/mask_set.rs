...
pub type MASK_SET_R = crate::FieldReader<u32, u32>;
#[doc = "Field `MASK_set` writer - "]
pub type MASK_SET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MASK_SET_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mask_set(&mut self) -> MASK_SET_W<0> {
        MASK_SET_W::new(self)
    }
