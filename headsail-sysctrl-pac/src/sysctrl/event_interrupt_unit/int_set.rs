...
pub type INT_SET_R = crate::FieldReader<u32, u32>;
#[doc = "Field `INT_set` writer - "]
pub type INT_SET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, INT_SET_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int_set(&mut self) -> INT_SET_W<0> {
        INT_SET_W::new(self)
    }
