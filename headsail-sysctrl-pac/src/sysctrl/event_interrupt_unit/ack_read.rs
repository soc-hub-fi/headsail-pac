...
pub type ACK_READ_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ACK_read` writer - "]
pub type ACK_READ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ACK_READ_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ack_read(&mut self) -> ACK_READ_W<0> {
        ACK_READ_W::new(self)
    }
