...
pub type CMP_HI_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CMP_HI` writer - "]
pub type CMP_HI_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP_HI_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp_hi(&mut self) -> CMP_HI_W<0> {
        CMP_HI_W::new(self)
    }
