...
pub type R = crate::R<Ddr2PllLoopCtrlSpec>;
#[doc = "Register `DDR2_PLL_LOOP_CTRL` writer"]
pub type W = crate::W<Ddr2PllLoopCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loop_ctrl(&mut self) -> LoopCtrlW<Ddr2PllLoopCtrlSpec> {
...
pub struct Ddr2PllLoopCtrlSpec;
impl crate::RegisterSpec for Ddr2PllLoopCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr2_pll_loop_ctrl::R`](R) reader structure"]
impl crate::Readable for Ddr2PllLoopCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ddr2_pll_loop_ctrl::W`](W) writer structure"]
impl crate::Writable for Ddr2PllLoopCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR2_PLL_LOOP_CTRL to value 0"]
impl crate::Resettable for Ddr2PllLoopCtrlSpec {
