...
pub type R = crate::R<DDR2_PLL_TMUX_SEL_SPEC>;
#[doc = "Register `DDR2_PLL_TMUX_SEL` writer"]
pub type W = crate::W<DDR2_PLL_TMUX_SEL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmux_1(&mut self) -> TMUX_1_W<DDR2_PLL_TMUX_SEL_SPEC> {
        TMUX_1_W::new(self, 0)
    }
    #[doc = "Bits 4:7"]
    #[inline(always)]
    #[must_use]
    pub fn tmux_2(&mut self) -> TMUX_2_W<DDR2_PLL_TMUX_SEL_SPEC> {
        TMUX_2_W::new(self, 4)
    }
}
