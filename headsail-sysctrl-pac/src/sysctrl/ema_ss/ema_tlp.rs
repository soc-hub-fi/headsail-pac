...
pub type R = crate::R<EMA_TLP_SPEC>;
#[doc = "Register `EMA_TLP` writer"]
pub type W = crate::W<EMA_TLP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dpram_ema(&mut self) -> DPRAM_EMA_W<EMA_TLP_SPEC> {
        DPRAM_EMA_W::new(self, 0)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    #[must_use]
    pub fn spram_ema(&mut self) -> SPRAM_EMA_W<EMA_TLP_SPEC> {
