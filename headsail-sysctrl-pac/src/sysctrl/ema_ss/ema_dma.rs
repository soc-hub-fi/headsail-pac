...
pub struct R(crate::R<EMA_DMA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EMA_DMA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EMA_DMA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EMA_DMA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EMA_DMA` writer"]
pub struct W(crate::W<EMA_DMA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EMA_DMA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EMA_DMA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EMA_DMA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DPRAM_EMA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EMA_DMA_SPEC, u8, u8, 8, O>;
#[doc = "Field `SPRAM_EMA` reader - "]
pub type SPRAM_EMA_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SPRAM_EMA` writer - "]
pub type SPRAM_EMA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EMA_DMA_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ema_dma](index.html) module"]
pub struct EMA_DMA_SPEC;
impl crate::RegisterSpec for EMA_DMA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ema_dma::R](R) reader structure"]
impl crate::Readable for EMA_DMA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ema_dma::W](W) writer structure"]
impl crate::Writable for EMA_DMA_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets EMA_DMA to value 0x00ff_00ff"]
impl crate::Resettable for EMA_DMA_SPEC {
