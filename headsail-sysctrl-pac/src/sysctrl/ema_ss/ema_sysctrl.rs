...
pub struct R(crate::R<EMA_SYSCTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EMA_SYSCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EMA_SYSCTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EMA_SYSCTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EMA_SYSCTRL` writer"]
pub struct W(crate::W<EMA_SYSCTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EMA_SYSCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EMA_SYSCTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EMA_SYSCTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DPRAM_EMA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EMA_SYSCTRL_SPEC, u8, u8, 8, O>;
#[doc = "Field `SPRAM_EMA` reader - "]
pub type SPRAM_EMA_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SPRAM_EMA` writer - "]
pub type SPRAM_EMA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EMA_SYSCTRL_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ema_sysctrl](index.html) module"]
