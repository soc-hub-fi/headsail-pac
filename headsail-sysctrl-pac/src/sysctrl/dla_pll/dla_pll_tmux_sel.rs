...
pub type R = crate::R<DlaPllTmuxSelSpec>;
#[doc = "Register `DLA_PLL_TMUX_SEL` writer"]
pub type W = crate::W<DlaPllTmuxSelSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmux_1(&mut self) -> Tmux1W<DlaPllTmuxSelSpec> {
        Tmux1W::new(self, 0)
    }
    #[doc = "Bits 4:7"]
    #[inline(always)]
    #[must_use]
    pub fn tmux_2(&mut self) -> Tmux2W<DlaPllTmuxSelSpec> {
        Tmux2W::new(self, 4)
    }
}
...
pub struct DlaPllTmuxSelSpec;
impl crate::RegisterSpec for DlaPllTmuxSelSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dla_pll_tmux_sel::R`](R) reader structure"]
impl crate::Readable for DlaPllTmuxSelSpec {}
#[doc = "`write(|w| ..)` method takes [`dla_pll_tmux_sel::W`](W) writer structure"]
impl crate::Writable for DlaPllTmuxSelSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DLA_PLL_TMUX_SEL to value 0"]
impl crate::Resettable for DlaPllTmuxSelSpec {
