...
pub struct R(crate::R<DLA_PLL_STATUS2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DLA_PLL_STATUS2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DLA_PLL_STATUS2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DLA_PLL_STATUS2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dla_pll_status2](index.html) module"]
