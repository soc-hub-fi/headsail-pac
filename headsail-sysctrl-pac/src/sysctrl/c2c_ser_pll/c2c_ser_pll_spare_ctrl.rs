...
pub type R = crate::R<C2C_SER_PLL_SPARE_CTRL_SPEC>;
#[doc = "Register `C2C_SER_PLL_SPARE_CTRL` writer"]
pub type W = crate::W<C2C_SER_PLL_SPARE_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spare_ctrl(&mut self) -> SPARE_CTRL_W<C2C_SER_PLL_SPARE_CTRL_SPEC> {
