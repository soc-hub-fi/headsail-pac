...
pub type R = crate::R<C2cSerPllDebugCtrlSpec>;
#[doc = "Register `C2C_SER_PLL_DEBUG_CTRL` writer"]
pub type W = crate::W<C2cSerPllDebugCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn debug_ctrl(&mut self) -> DebugCtrlW<C2cSerPllDebugCtrlSpec> {
...
pub struct C2cSerPllDebugCtrlSpec;
impl crate::RegisterSpec for C2cSerPllDebugCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c2c_ser_pll_debug_ctrl::R`](R) reader structure"]
impl crate::Readable for C2cSerPllDebugCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`c2c_ser_pll_debug_ctrl::W`](W) writer structure"]
impl crate::Writable for C2cSerPllDebugCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets C2C_SER_PLL_DEBUG_CTRL to value 0"]
impl crate::Resettable for C2cSerPllDebugCtrlSpec {
