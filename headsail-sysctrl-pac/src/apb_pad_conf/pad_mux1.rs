...
pub type R = crate::R<PAD_MUX1_SPEC>;
#[doc = "Register `pad_mux1` writer"]
pub type W = crate::W<PAD_MUX1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux_select(&mut self) -> MUX_SELECT_W<PAD_MUX1_SPEC> {
...
pub struct PAD_MUX1_SPEC;
impl crate::RegisterSpec for PAD_MUX1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pad_mux1::R`](R) reader structure"]
impl crate::Readable for PAD_MUX1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`pad_mux1::W`](W) writer structure"]
impl crate::Writable for PAD_MUX1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets pad_mux1 to value 0"]
impl crate::Resettable for PAD_MUX1_SPEC {
