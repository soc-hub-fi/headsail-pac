...
pub type R = crate::R<Spis1Sdio1Spec>;
#[doc = "Register `spis1_sdio1` writer"]
pub type W = crate::W<Spis1Sdio1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ds0(&mut self) -> Ds0W<Spis1Sdio1Spec> {
        Ds0W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ds1(&mut self) -> Ds1W<Spis1Sdio1Spec> {
        Ds1W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn st0(&mut self) -> St0W<Spis1Sdio1Spec> {
        St0W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn st1(&mut self) -> St1W<Spis1Sdio1Spec> {
        St1W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn rate_control(&mut self) -> RateControlW<Spis1Sdio1Spec> {
        RateControlW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn output_en(&mut self) -> OutputEnW<Spis1Sdio1Spec> {
        OutputEnW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HoldW<Spis1Sdio1Spec> {
        HoldW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pull_enable(&mut self) -> PullEnableW<Spis1Sdio1Spec> {
        PullEnableW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pull_dir(&mut self) -> PullDirW<Spis1Sdio1Spec> {
        PullDirW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn input_en(&mut self) -> InputEnW<Spis1Sdio1Spec> {
        InputEnW::new(self, 9)
    }
}
...
pub struct Spis1Sdio1Spec;
impl crate::RegisterSpec for Spis1Sdio1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spis1_sdio1::R`](R) reader structure"]
impl crate::Readable for Spis1Sdio1Spec {}
#[doc = "`write(|w| ..)` method takes [`spis1_sdio1::W`](W) writer structure"]
impl crate::Writable for Spis1Sdio1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets spis1_sdio1 to value 0"]
impl crate::Resettable for Spis1Sdio1Spec {
