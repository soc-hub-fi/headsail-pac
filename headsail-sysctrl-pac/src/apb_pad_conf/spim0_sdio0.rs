...
pub type R = crate::R<Spim0Sdio0Spec>;
#[doc = "Register `spim0_sdio0` writer"]
pub type W = crate::W<Spim0Sdio0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ds0(&mut self) -> Ds0W<Spim0Sdio0Spec> {
        Ds0W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ds1(&mut self) -> Ds1W<Spim0Sdio0Spec> {
        Ds1W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn st0(&mut self) -> St0W<Spim0Sdio0Spec> {
        St0W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn st1(&mut self) -> St1W<Spim0Sdio0Spec> {
        St1W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn rate_control(&mut self) -> RateControlW<Spim0Sdio0Spec> {
        RateControlW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn output_en(&mut self) -> OutputEnW<Spim0Sdio0Spec> {
        OutputEnW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HoldW<Spim0Sdio0Spec> {
        HoldW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pull_enable(&mut self) -> PullEnableW<Spim0Sdio0Spec> {
        PullEnableW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pull_dir(&mut self) -> PullDirW<Spim0Sdio0Spec> {
        PullDirW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn input_en(&mut self) -> InputEnW<Spim0Sdio0Spec> {
        InputEnW::new(self, 9)
    }
}
...
pub struct Spim0Sdio0Spec;
impl crate::RegisterSpec for Spim0Sdio0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spim0_sdio0::R`](R) reader structure"]
impl crate::Readable for Spim0Sdio0Spec {}
#[doc = "`write(|w| ..)` method takes [`spim0_sdio0::W`](W) writer structure"]
impl crate::Writable for Spim0Sdio0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets spim0_sdio0 to value 0"]
impl crate::Resettable for Spim0Sdio0Spec {
