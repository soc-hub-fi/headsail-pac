...
pub type R = crate::R<PAD_C2C_CONFIG_1_SPEC>;
#[doc = "Register `PAD_C2C_CONFIG_1` writer"]
pub type W = crate::W<PAD_C2C_CONFIG_1_SPEC>;
...
pub type PAD_PHY_DATA_ACK_TX_CONFIG_R = crate::FieldReader<u16>;
...
pub type PAD_PHY_DATA_ACK_TX_CONFIG_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
...
pub type PAD_PHY_DATA_VALID_TX_CONFIG_R = crate::FieldReader<u16>;
...
pub type PAD_PHY_DATA_VALID_TX_CONFIG_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
...
pub type PAD_PHY_DATA_TX_CONFIG_R = crate::FieldReader<u16>;
...
pub type PAD_PHY_DATA_TX_CONFIG_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pad_phy_data_ack_tx_config(
        &mut self,
    ) -> PAD_PHY_DATA_ACK_TX_CONFIG_W<PAD_C2C_CONFIG_1_SPEC> {
        PAD_PHY_DATA_ACK_TX_CONFIG_W::new(self, 0)
    }
    #[doc = "Bits 10:19 - 0: drive strenght / 1: drive strenght / 2: schmitt trigger / 3: schmitt trigger / 4: rate / 5: output en(0) / 6: hold / 7: pull enable / 8: pd(0)/pu(1) / 9: input en(1)"]
    #[inline(always)]
    #[must_use]
    pub fn pad_phy_data_valid_tx_config(
        &mut self,
    ) -> PAD_PHY_DATA_VALID_TX_CONFIG_W<PAD_C2C_CONFIG_1_SPEC> {
        PAD_PHY_DATA_VALID_TX_CONFIG_W::new(self, 10)
    }
    #[doc = "Bits 20:29 - 0: drive strenght / 1: drive strenght / 2: schmitt trigger / 3: schmitt trigger / 4: rate / 5: output en(0) / 6: hold / 7: pull enable / 8: pd(0)/pu(1) / 9: input en(1)"]
    #[inline(always)]
    #[must_use]
    pub fn pad_phy_data_tx_config(&mut self) -> PAD_PHY_DATA_TX_CONFIG_W<PAD_C2C_CONFIG_1_SPEC> {
        PAD_PHY_DATA_TX_CONFIG_W::new(self, 20)
    }
}
