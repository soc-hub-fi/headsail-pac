...
pub struct R(crate::R<PAD_C2C_CONFIG_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PAD_C2C_CONFIG_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PAD_C2C_CONFIG_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PAD_C2C_CONFIG_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PAD_C2C_CONFIG_1` writer"]
pub struct W(crate::W<PAD_C2C_CONFIG_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PAD_C2C_CONFIG_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PAD_C2C_CONFIG_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PAD_C2C_CONFIG_1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PAD_PHY_DATA_ACK_TX_CONFIG_R = crate::FieldReader<u16, u16>;
...
pub type PAD_PHY_DATA_ACK_TX_CONFIG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PAD_C2C_CONFIG_1_SPEC, u16, u16, 10, O>;
...
pub type PAD_PHY_DATA_VALID_TX_CONFIG_R = crate::FieldReader<u16, u16>;
...
pub type PAD_PHY_DATA_VALID_TX_CONFIG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PAD_C2C_CONFIG_1_SPEC, u16, u16, 10, O>;
...
pub type PAD_PHY_DATA_TX_CONFIG_R = crate::FieldReader<u16, u16>;
...
pub type PAD_PHY_DATA_TX_CONFIG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PAD_C2C_CONFIG_1_SPEC, u16, u16, 10, O>;
impl R {
    ...
    #[inline(always)]
    pub fn pad_phy_data_ack_tx_config(&self) -> PAD_PHY_DATA_ACK_TX_CONFIG_R {
        PAD_PHY_DATA_ACK_TX_CONFIG_R::new((self.bits & 0x03ff) as u16)
    }
    ...
    #[inline(always)]
    pub fn pad_phy_data_valid_tx_config(&self) -> PAD_PHY_DATA_VALID_TX_CONFIG_R {
        PAD_PHY_DATA_VALID_TX_CONFIG_R::new(((self.bits >> 10) & 0x03ff) as u16)
    }
    ...
    #[inline(always)]
    pub fn pad_phy_data_tx_config(&self) -> PAD_PHY_DATA_TX_CONFIG_R {
        PAD_PHY_DATA_TX_CONFIG_R::new(((self.bits >> 20) & 0x03ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:9 - 0: drive strenght / 1: drive strenght / 2: schmitt trigger / 3: schmitt trigger / 4: rate / 5: output en(0) / 6: hold / 7: pull enable / 8: pd(0)/pu(1) / 9: input en(1)"]
    #[inline(always)]
    #[must_use]
    pub fn pad_phy_data_ack_tx_config(&mut self) -> PAD_PHY_DATA_ACK_TX_CONFIG_W<0> {
        PAD_PHY_DATA_ACK_TX_CONFIG_W::new(self)
    }
    #[doc = "Bits 10:19 - 0: drive strenght / 1: drive strenght / 2: schmitt trigger / 3: schmitt trigger / 4: rate / 5: output en(0) / 6: hold / 7: pull enable / 8: pd(0)/pu(1) / 9: input en(1)"]
    #[inline(always)]
    #[must_use]
    pub fn pad_phy_data_valid_tx_config(&mut self) -> PAD_PHY_DATA_VALID_TX_CONFIG_W<10> {
        PAD_PHY_DATA_VALID_TX_CONFIG_W::new(self)
    }
    #[doc = "Bits 20:29 - 0: drive strenght / 1: drive strenght / 2: schmitt trigger / 3: schmitt trigger / 4: rate / 5: output en(0) / 6: hold / 7: pull enable / 8: pd(0)/pu(1) / 9: input en(1)"]
    #[inline(always)]
    #[must_use]
    pub fn pad_phy_data_tx_config(&mut self) -> PAD_PHY_DATA_TX_CONFIG_W<20> {
        PAD_PHY_DATA_TX_CONFIG_W::new(self)
    }
