...
pub struct W(crate::W<D_DESTINATION_MODE_UNSET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_DESTINATION_MODE_UNSET_SPEC>;
    #[inline(always)]
...
impl From<crate::W<D_DESTINATION_MODE_UNSET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_DESTINATION_MODE_UNSET_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `Destination_Mode_Unset` writer - "]
pub type DESTINATION_MODE_UNSET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DESTINATION_MODE_UNSET_SPEC, u32, u32, 32, O>;
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    #[must_use]
...
#[doc = "Write to unset destination mode register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [d_destination_mode_unset](index.html) module"]
