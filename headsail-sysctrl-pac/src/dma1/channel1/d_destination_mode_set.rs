...
pub type W = crate::W<D_DESTINATION_MODE_SET_SPEC>;
#[doc = "Field `Destination_Mode_Set` writer - "]
pub type DESTINATION_MODE_SET_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
#[cfg(feature = "derive-debug")]
impl core::fmt::Debug for crate::generic::Reg<D_DESTINATION_MODE_SET_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn destination_mode_set(&mut self) -> DESTINATION_MODE_SET_W<D_DESTINATION_MODE_SET_SPEC> {
