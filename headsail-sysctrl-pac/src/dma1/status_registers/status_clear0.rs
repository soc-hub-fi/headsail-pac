#[doc = "Register `STATUS_CLEAR0` reader"]
pub struct R(crate::R<STATUS_CLEAR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<STATUS_CLEAR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<STATUS_CLEAR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<STATUS_CLEAR0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `STATUS_CLEAR0` writer"]
pub struct W(crate::W<STATUS_CLEAR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<STATUS_CLEAR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<STATUS_CLEAR0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<STATUS_CLEAR0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WR_TRANSFER_COMPLETED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, STATUS_CLEAR0_SPEC, bool, O>;
...
pub type RB_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_CLEAR0_SPEC, bool, O>;
#[doc = "Field `wb_error` reader - "]
pub type WB_ERROR_R = crate::BitReader<bool>;
#[doc = "Field `wb_error` writer - "]
pub type WB_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_CLEAR0_SPEC, bool, O>;
#[doc = "Field `fifo_overflow` reader - "]
pub type FIFO_OVERFLOW_R = crate::BitReader<bool>;
#[doc = "Field `fifo_overflow` writer - "]
pub type FIFO_OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_CLEAR0_SPEC, bool, O>;
#[doc = "Field `fifo_underflow` reader - "]
pub type FIFO_UNDERFLOW_R = crate::BitReader<bool>;
#[doc = "Field `fifo_underflow` writer - "]
pub type FIFO_UNDERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_CLEAR0_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
#[doc = "Acknowledging status register for Channels(0-3). Clearing each one by setting corresponding bit\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [status_clear0](index.html) module"]
pub struct STATUS_CLEAR0_SPEC;
impl crate::RegisterSpec for STATUS_CLEAR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [status_clear0::R](R) reader structure"]
impl crate::Readable for STATUS_CLEAR0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [status_clear0::W](W) writer structure"]
impl crate::Writable for STATUS_CLEAR0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets STATUS_CLEAR0 to value 0"]
impl crate::Resettable for STATUS_CLEAR0_SPEC {
