...
pub type R = crate::R<D_WRLATCORR_SPEC>;
#[doc = "Register `d_wrlatcorr` writer"]
pub type W = crate::W<D_WRLATCORR_SPEC>;
#[doc = "Field `d_wrlatcorr` reader - "]
pub type D_WRLATCORR_R = crate::FieldReader<u32>;
#[doc = "Field `d_wrlatcorr` writer - "]
pub type D_WRLATCORR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn d_wrlatcorr(&mut self) -> D_WRLATCORR_W<D_WRLATCORR_SPEC> {
        D_WRLATCORR_W::new(self, 0)
    }
}
