...
pub type R = crate::R<D_WRSEPARATION_SPEC>;
#[doc = "Register `d_wrseparation` writer"]
pub type W = crate::W<D_WRSEPARATION_SPEC>;
#[doc = "Field `d_wrseparation` reader - "]
pub type D_WRSEPARATION_R = crate::FieldReader<u32>;
#[doc = "Field `d_wrseparation` writer - "]
pub type D_WRSEPARATION_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn d_wrseparation(&mut self) -> D_WRSEPARATION_W<D_WRSEPARATION_SPEC> {
        D_WRSEPARATION_W::new(self, 0)
    }
}
