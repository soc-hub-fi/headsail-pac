...
pub type R = crate::R<C_BANK_SHIFT_SPEC>;
#[doc = "Register `c_bank_shift` writer"]
pub type W = crate::W<C_BANK_SHIFT_SPEC>;
#[doc = "Field `c_bank_shift` reader - "]
pub type C_BANK_SHIFT_R = crate::FieldReader<u32>;
#[doc = "Field `c_bank_shift` writer - "]
pub type C_BANK_SHIFT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn c_bank_shift(&mut self) -> C_BANK_SHIFT_W<C_BANK_SHIFT_SPEC> {
        C_BANK_SHIFT_W::new(self, 0)
    }
}
