...
pub struct R(crate::R<BUS_TRACE4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BUS_TRACE4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BUS_TRACE4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BUS_TRACE4_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [bus_trace4](index.html) module"]
