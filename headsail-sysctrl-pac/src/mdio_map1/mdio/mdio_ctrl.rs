...
pub type MDIO_CTRL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MDIO_CTRL` writer - "]
pub type MDIO_CTRL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDIO_CTRL_SPEC, u8, u8, 3, O>;
impl R {
    #[doc = "Bits 0:2"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdio_ctrl(&mut self) -> MDIO_CTRL_W<0> {
        MDIO_CTRL_W::new(self)
    }
