#[doc = "Register `cpi_vsync_pad_conf_reg` reader"]
pub struct R(crate::R<CPI_VSYNC_PAD_CONF_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CPI_VSYNC_PAD_CONF_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CPI_VSYNC_PAD_CONF_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CPI_VSYNC_PAD_CONF_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `cpi_vsync_pad_conf_reg` writer"]
pub struct W(crate::W<CPI_VSYNC_PAD_CONF_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CPI_VSYNC_PAD_CONF_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CPI_VSYNC_PAD_CONF_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CPI_VSYNC_PAD_CONF_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DS0_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPI_VSYNC_PAD_CONF_REG_SPEC, bool, O>;
#[doc = "Field `DS1` reader - "]
pub type DS1_R = crate::BitReader<bool>;
#[doc = "Field `DS1` writer - "]
pub type DS1_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPI_VSYNC_PAD_CONF_REG_SPEC, bool, O>;
#[doc = "Field `ST0` reader - "]
pub type ST0_R = crate::BitReader<bool>;
#[doc = "Field `ST0` writer - "]
pub type ST0_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPI_VSYNC_PAD_CONF_REG_SPEC, bool, O>;
#[doc = "Field `ST1` reader - "]
pub type ST1_R = crate::BitReader<bool>;
#[doc = "Field `ST1` writer - "]
pub type ST1_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPI_VSYNC_PAD_CONF_REG_SPEC, bool, O>;
...
pub type RATE_CONTROL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CPI_VSYNC_PAD_CONF_REG_SPEC, bool, O>;
...
pub type HOLD_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPI_VSYNC_PAD_CONF_REG_SPEC, bool, O>;
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cpi_vsync_pad_conf_reg](index.html) module"]
pub struct CPI_VSYNC_PAD_CONF_REG_SPEC;
impl crate::RegisterSpec for CPI_VSYNC_PAD_CONF_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cpi_vsync_pad_conf_reg::R](R) reader structure"]
impl crate::Readable for CPI_VSYNC_PAD_CONF_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cpi_vsync_pad_conf_reg::W](W) writer structure"]
impl crate::Writable for CPI_VSYNC_PAD_CONF_REG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets cpi_vsync_pad_conf_reg to value 0"]
impl crate::Resettable for CPI_VSYNC_PAD_CONF_REG_SPEC {
