#[doc = "Register `sdio_sddata3_pad_conf_reg` reader"]
pub struct R(crate::R<SDIO_SDDATA3_PAD_CONF_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SDIO_SDDATA3_PAD_CONF_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SDIO_SDDATA3_PAD_CONF_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SDIO_SDDATA3_PAD_CONF_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `sdio_sddata3_pad_conf_reg` writer"]
pub struct W(crate::W<SDIO_SDDATA3_PAD_CONF_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SDIO_SDDATA3_PAD_CONF_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SDIO_SDDATA3_PAD_CONF_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SDIO_SDDATA3_PAD_CONF_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DS0_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SDIO_SDDATA3_PAD_CONF_REG_SPEC, bool, O>;
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sdio_sddata3_pad_conf_reg](index.html) module"]
pub struct SDIO_SDDATA3_PAD_CONF_REG_SPEC;
impl crate::RegisterSpec for SDIO_SDDATA3_PAD_CONF_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sdio_sddata3_pad_conf_reg::R](R) reader structure"]
impl crate::Readable for SDIO_SDDATA3_PAD_CONF_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sdio_sddata3_pad_conf_reg::W](W) writer structure"]
impl crate::Writable for SDIO_SDDATA3_PAD_CONF_REG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets sdio_sddata3_pad_conf_reg to value 0"]
impl crate::Resettable for SDIO_SDDATA3_PAD_CONF_REG_SPEC {
