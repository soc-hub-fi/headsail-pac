...
pub type R = crate::R<PadRgmii2RxClkSpec>;
#[doc = "Register `PAD_RGMII_2_RX_CLK` writer"]
pub type W = crate::W<PadRgmii2RxClkSpec>;
#[doc = "\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ds0(&mut self) -> Ds0W<PadRgmii2RxClkSpec> {
        Ds0W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ds1(&mut self) -> Ds1W<PadRgmii2RxClkSpec> {
        Ds1W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn st0(&mut self) -> St0W<PadRgmii2RxClkSpec> {
        St0W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn st1(&mut self) -> St1W<PadRgmii2RxClkSpec> {
        St1W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn rate_control(&mut self) -> RateControlW<PadRgmii2RxClkSpec> {
        RateControlW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn output_en(&mut self) -> OutputEnW<PadRgmii2RxClkSpec> {
        OutputEnW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HoldW<PadRgmii2RxClkSpec> {
        HoldW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pull_enable(&mut self) -> PullEnableW<PadRgmii2RxClkSpec> {
        PullEnableW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pull_dir(&mut self) -> PullDirW<PadRgmii2RxClkSpec> {
        PullDirW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn input_en(&mut self) -> InputEnW<PadRgmii2RxClkSpec> {
        InputEnW::new(self, 9)
    }
}
...
pub struct PadRgmii2RxClkSpec;
impl crate::RegisterSpec for PadRgmii2RxClkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pad_rgmii_2_rx_clk::R`](R) reader structure"]
impl crate::Readable for PadRgmii2RxClkSpec {}
#[doc = "`write(|w| ..)` method takes [`pad_rgmii_2_rx_clk::W`](W) writer structure"]
impl crate::Writable for PadRgmii2RxClkSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PAD_RGMII_2_RX_CLK to value 0x0224"]
impl crate::Resettable for PadRgmii2RxClkSpec {
