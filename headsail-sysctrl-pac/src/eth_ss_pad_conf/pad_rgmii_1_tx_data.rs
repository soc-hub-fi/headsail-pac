...
pub type R = crate::R<PadRgmii1TxDataSpec>;
#[doc = "Register `PAD_RGMII_1_TX_DATA` writer"]
pub type W = crate::W<PadRgmii1TxDataSpec>;
#[doc = "\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ds0(&mut self) -> Ds0W<PadRgmii1TxDataSpec> {
        Ds0W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ds1(&mut self) -> Ds1W<PadRgmii1TxDataSpec> {
        Ds1W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn st0(&mut self) -> St0W<PadRgmii1TxDataSpec> {
        St0W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn st1(&mut self) -> St1W<PadRgmii1TxDataSpec> {
        St1W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn rate_control(&mut self) -> RateControlW<PadRgmii1TxDataSpec> {
        RateControlW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn output_en(&mut self) -> OutputEnW<PadRgmii1TxDataSpec> {
        OutputEnW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HoldW<PadRgmii1TxDataSpec> {
        HoldW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pull_enable(&mut self) -> PullEnableW<PadRgmii1TxDataSpec> {
        PullEnableW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pull_dir(&mut self) -> PullDirW<PadRgmii1TxDataSpec> {
        PullDirW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn input_en(&mut self) -> InputEnW<PadRgmii1TxDataSpec> {
        InputEnW::new(self, 9)
    }
}
...
pub struct PadRgmii1TxDataSpec;
impl crate::RegisterSpec for PadRgmii1TxDataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pad_rgmii_1_tx_data::R`](R) reader structure"]
impl crate::Readable for PadRgmii1TxDataSpec {}
#[doc = "`write(|w| ..)` method takes [`pad_rgmii_1_tx_data::W`](W) writer structure"]
impl crate::Writable for PadRgmii1TxDataSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PAD_RGMII_1_TX_DATA to value 0x11"]
impl crate::Resettable for PadRgmii1TxDataSpec {
