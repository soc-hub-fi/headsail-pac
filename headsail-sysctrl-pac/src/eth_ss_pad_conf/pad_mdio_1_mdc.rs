...
pub type R = crate::R<PadMdio1MdcSpec>;
#[doc = "Register `PAD_MDIO_1_MDC` writer"]
pub type W = crate::W<PadMdio1MdcSpec>;
#[doc = "\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ds0(&mut self) -> Ds0W<PadMdio1MdcSpec> {
        Ds0W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ds1(&mut self) -> Ds1W<PadMdio1MdcSpec> {
        Ds1W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn st0(&mut self) -> St0W<PadMdio1MdcSpec> {
        St0W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn st1(&mut self) -> St1W<PadMdio1MdcSpec> {
        St1W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn rate_control(&mut self) -> RateControlW<PadMdio1MdcSpec> {
        RateControlW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn output_en(&mut self) -> OutputEnW<PadMdio1MdcSpec> {
        OutputEnW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HoldW<PadMdio1MdcSpec> {
        HoldW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pull_enable(&mut self) -> PullEnableW<PadMdio1MdcSpec> {
        PullEnableW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pull_dir(&mut self) -> PullDirW<PadMdio1MdcSpec> {
        PullDirW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn input_en(&mut self) -> InputEnW<PadMdio1MdcSpec> {
        InputEnW::new(self, 9)
    }
}
...
pub struct PadMdio1MdcSpec;
impl crate::RegisterSpec for PadMdio1MdcSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pad_mdio_1_mdc::R`](R) reader structure"]
impl crate::Readable for PadMdio1MdcSpec {}
#[doc = "`write(|w| ..)` method takes [`pad_mdio_1_mdc::W`](W) writer structure"]
impl crate::Writable for PadMdio1MdcSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PAD_MDIO_1_MDC to value 0x11"]
impl crate::Resettable for PadMdio1MdcSpec {
