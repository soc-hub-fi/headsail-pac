...
pub type R = crate::R<PadMdio1MdioSpec>;
#[doc = "Register `PAD_MDIO_1_MDIO` writer"]
pub type W = crate::W<PadMdio1MdioSpec>;
#[doc = "\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ds0(&mut self) -> Ds0W<PadMdio1MdioSpec> {
        Ds0W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ds1(&mut self) -> Ds1W<PadMdio1MdioSpec> {
        Ds1W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn st0(&mut self) -> St0W<PadMdio1MdioSpec> {
        St0W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn st1(&mut self) -> St1W<PadMdio1MdioSpec> {
        St1W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn rate_control(&mut self) -> RateControlW<PadMdio1MdioSpec> {
        RateControlW::new(self, 4)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HoldW<PadMdio1MdioSpec> {
        HoldW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pull_enable(&mut self) -> PullEnableW<PadMdio1MdioSpec> {
        PullEnableW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pull_dir(&mut self) -> PullDirW<PadMdio1MdioSpec> {
        PullDirW::new(self, 8)
    }
}
...
pub struct PadMdio1MdioSpec;
impl crate::RegisterSpec for PadMdio1MdioSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pad_mdio_1_mdio::R`](R) reader structure"]
impl crate::Readable for PadMdio1MdioSpec {}
#[doc = "`write(|w| ..)` method takes [`pad_mdio_1_mdio::W`](W) writer structure"]
impl crate::Writable for PadMdio1MdioSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PAD_MDIO_1_MDIO to value 0x0235"]
impl crate::Resettable for PadMdio1MdioSpec {
