...
pub type R = crate::R<PadMdio2MdioSpec>;
#[doc = "Register `PAD_MDIO_2_MDIO` writer"]
pub type W = crate::W<PadMdio2MdioSpec>;
#[doc = "\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ds0(&mut self) -> Ds0W<PadMdio2MdioSpec> {
        Ds0W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ds1(&mut self) -> Ds1W<PadMdio2MdioSpec> {
        Ds1W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn st0(&mut self) -> St0W<PadMdio2MdioSpec> {
        St0W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn st1(&mut self) -> St1W<PadMdio2MdioSpec> {
        St1W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn rate_control(&mut self) -> RateControlW<PadMdio2MdioSpec> {
        RateControlW::new(self, 4)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HoldW<PadMdio2MdioSpec> {
        HoldW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pull_enable(&mut self) -> PullEnableW<PadMdio2MdioSpec> {
        PullEnableW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pull_dir(&mut self) -> PullDirW<PadMdio2MdioSpec> {
        PullDirW::new(self, 8)
    }
}
...
pub struct PadMdio2MdioSpec;
impl crate::RegisterSpec for PadMdio2MdioSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pad_mdio_2_mdio::R`](R) reader structure"]
impl crate::Readable for PadMdio2MdioSpec {}
#[doc = "`write(|w| ..)` method takes [`pad_mdio_2_mdio::W`](W) writer structure"]
impl crate::Writable for PadMdio2MdioSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PAD_MDIO_2_MDIO to value 0x0235"]
impl crate::Resettable for PadMdio2MdioSpec {
