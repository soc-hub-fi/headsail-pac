...
pub type R = crate::R<LaneConfigSpec>;
#[doc = "Register `LANE_CONFIG[%s]` writer"]
pub type W = crate::W<LaneConfigSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn config(&mut self) -> ConfigW<LaneConfigSpec> {
        ConfigW::new(self, 0)
    }
}
...
pub struct LaneConfigSpec;
impl crate::RegisterSpec for LaneConfigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lane_config::R`](R) reader structure"]
impl crate::Readable for LaneConfigSpec {}
#[doc = "`write(|w| ..)` method takes [`lane_config::W`](W) writer structure"]
impl crate::Writable for LaneConfigSpec {
...
to value 0"]
impl crate::Resettable for LaneConfigSpec {
