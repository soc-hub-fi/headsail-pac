...
pub struct CONFIGURATION {
    ...
    _reserved12: [u8; 0x10],
    #[doc = "0x40 - "]
    pub clk_divider_conf: CLK_DIVIDER_CONF,
    #[doc = "0x44..0x54 - "]
    pub lane_config: [LANE_CONFIG; 4],
    #[doc = "0x54..0x64 - "]
    pub test_diagnosis_config: [TEST_DIAGNOSIS_CONFIG; 4],
    #[doc = "0x64..0x74 - "]
    pub lane_status: [LANE_STATUS; 4],
}
...
pub mod info;
#[doc = "CLK_DIVIDER_CONF (rw) register accessor: an alias for `Reg<CLK_DIVIDER_CONF_SPEC>`"]
pub type CLK_DIVIDER_CONF = crate::Reg<clk_divider_conf::CLK_DIVIDER_CONF_SPEC>;
#[doc = ""]
pub mod clk_divider_conf;
#[doc = "LANE_STATUS (r) register accessor: an alias for `Reg<LANE_STATUS_SPEC>`"]
pub type LANE_STATUS = crate::Reg<lane_status::LANE_STATUS_SPEC>;
#[doc = ""]
pub mod lane_status;
#[doc = "TEST_DIAGNOSIS_CONFIG (rw) register accessor: an alias for `Reg<TEST_DIAGNOSIS_CONFIG_SPEC>`"]
pub type TEST_DIAGNOSIS_CONFIG = crate::Reg<test_diagnosis_config::TEST_DIAGNOSIS_CONFIG_SPEC>;
#[doc = ""]
pub mod test_diagnosis_config;
#[doc = "LANE_CONFIG (rw) register accessor: an alias for `Reg<LANE_CONFIG_SPEC>`"]
