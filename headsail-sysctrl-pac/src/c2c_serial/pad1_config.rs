...
pub type R = crate::R<Pad1ConfigSpec>;
#[doc = "Register `PAD1_CONFIG` writer"]
pub type W = crate::W<Pad1ConfigSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pad_ser_data_tx_config(&mut self) -> PadSerDataTxConfigW<Pad1ConfigSpec> {
        PadSerDataTxConfigW::new(self, 0)
    }
    #[doc = "Bits 10:19 - 0: drive strenght / 1: drive strenght / 2: schmitt trigger / 3: schmitt trigger / 4: rate / 5: output en(0) / 6: hold / 7: pull enable / 8: pd(0)/pu(1) / 9: input en(1)"]
    #[inline(always)]
    #[must_use]
    pub fn pad_ser_data_rx_config(&mut self) -> PadSerDataRxConfigW<Pad1ConfigSpec> {
        PadSerDataRxConfigW::new(self, 10)
    }
    #[doc = "Bits 20:29 - 0: drive strenght / 1: drive strenght / 2: schmitt trigger / 3: schmitt trigger / 4: rate / 5: output en(0) / 6: hold / 7: pull enable / 8: pd(0)/pu(1) / 9: input en(1)"]
    #[inline(always)]
    #[must_use]
    pub fn pad_ser_clk_config(&mut self) -> PadSerClkConfigW<Pad1ConfigSpec> {
...
pub struct Pad1ConfigSpec;
impl crate::RegisterSpec for Pad1ConfigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pad1_config::R`](R) reader structure"]
impl crate::Readable for Pad1ConfigSpec {}
#[doc = "`write(|w| ..)` method takes [`pad1_config::W`](W) writer structure"]
impl crate::Writable for Pad1ConfigSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PAD1_CONFIG to value 0"]
impl crate::Resettable for Pad1ConfigSpec {
