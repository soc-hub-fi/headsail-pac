...
pub struct R(crate::R<TIMER3_CMP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMER3_CMP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMER3_CMP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMER3_CMP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `timer3_cmp` writer"]
pub struct W(crate::W<TIMER3_CMP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMER3_CMP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIMER3_CMP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIMER3_CMP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMER3_CMP_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
