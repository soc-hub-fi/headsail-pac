...
pub struct R(crate::R<CLAIM_COMPLETE_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLAIM_COMPLETE_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLAIM_COMPLETE_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLAIM_COMPLETE_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `claim_complete_0` writer"]
pub struct W(crate::W<CLAIM_COMPLETE_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLAIM_COMPLETE_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CLAIM_COMPLETE_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLAIM_COMPLETE_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CLAIM_COMPLETE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLAIM_COMPLETE_0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
