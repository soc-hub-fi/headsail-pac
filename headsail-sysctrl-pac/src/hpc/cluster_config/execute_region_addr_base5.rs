...
pub type R = crate::R<EXECUTE_REGION_ADDR_BASE5_SPEC>;
#[doc = "Register `execute_region_addr_base5` writer"]
pub type W = crate::W<EXECUTE_REGION_ADDR_BASE5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn base(&mut self) -> BASE_W<EXECUTE_REGION_ADDR_BASE5_SPEC> {
        BASE_W::new(self, 0)
    }
}
