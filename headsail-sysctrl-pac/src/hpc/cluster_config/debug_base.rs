...
pub type R = crate::R<DebugBaseSpec>;
#[doc = "Register `debug_base` writer"]
pub type W = crate::W<DebugBaseSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn base(&mut self) -> BaseW<DebugBaseSpec> {
        BaseW::new(self, 0)
    }
}
...
pub struct DebugBaseSpec;
impl crate::RegisterSpec for DebugBaseSpec {
    type Ux = u64;
}
#[doc = "`read()` method returns [`debug_base::R`](R) reader structure"]
impl crate::Readable for DebugBaseSpec {}
#[doc = "`write(|w| ..)` method takes [`debug_base::W`](W) writer structure"]
impl crate::Writable for DebugBaseSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
}
#[doc = "`reset()` method sets debug_base to value 0"]
impl crate::Resettable for DebugBaseSpec {
