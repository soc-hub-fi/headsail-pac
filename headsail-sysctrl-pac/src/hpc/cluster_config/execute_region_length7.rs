...
pub type R = crate::R<ExecuteRegionLength7Spec>;
#[doc = "Register `execute_region_length7` writer"]
pub type W = crate::W<ExecuteRegionLength7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn len(&mut self) -> LenW<ExecuteRegionLength7Spec> {
        LenW::new(self, 0)
    }
}
...
pub struct ExecuteRegionLength7Spec;
impl crate::RegisterSpec for ExecuteRegionLength7Spec {
    type Ux = u64;
}
#[doc = "`read()` method returns [`execute_region_length7::R`](R) reader structure"]
impl crate::Readable for ExecuteRegionLength7Spec {}
#[doc = "`write(|w| ..)` method takes [`execute_region_length7::W`](W) writer structure"]
impl crate::Writable for ExecuteRegionLength7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
}
#[doc = "`reset()` method sets execute_region_length7 to value 0"]
impl crate::Resettable for ExecuteRegionLength7Spec {
