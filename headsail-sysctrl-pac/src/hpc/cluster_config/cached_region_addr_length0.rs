...
pub type R = crate::R<CACHED_REGION_ADDR_LENGTH0_SPEC>;
#[doc = "Register `cached_region_addr_length0` writer"]
pub type W = crate::W<CACHED_REGION_ADDR_LENGTH0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn len(&mut self) -> LEN_W<CACHED_REGION_ADDR_LENGTH0_SPEC> {
        LEN_W::new(self, 0)
    }
}
