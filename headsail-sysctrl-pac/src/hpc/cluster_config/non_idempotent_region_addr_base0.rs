...
pub struct R(crate::R<NON_IDEMPOTENT_REGION_ADDR_BASE0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<NON_IDEMPOTENT_REGION_ADDR_BASE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<NON_IDEMPOTENT_REGION_ADDR_BASE0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<NON_IDEMPOTENT_REGION_ADDR_BASE0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `non_idempotent_region_addr_base0` writer"]
pub struct W(crate::W<NON_IDEMPOTENT_REGION_ADDR_BASE0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<NON_IDEMPOTENT_REGION_ADDR_BASE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<NON_IDEMPOTENT_REGION_ADDR_BASE0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<NON_IDEMPOTENT_REGION_ADDR_BASE0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BASE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u64, NON_IDEMPOTENT_REGION_ADDR_BASE0_SPEC, u64, u64, 64, O>;
impl R {
