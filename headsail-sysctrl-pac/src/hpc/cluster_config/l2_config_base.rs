...
pub struct R(crate::R<L2_CONFIG_BASE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L2_CONFIG_BASE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L2_CONFIG_BASE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L2_CONFIG_BASE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `l2_config_base` writer"]
pub struct W(crate::W<L2_CONFIG_BASE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L2_CONFIG_BASE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L2_CONFIG_BASE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L2_CONFIG_BASE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BASE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u64, L2_CONFIG_BASE_SPEC, u64, u64, 64, O>;
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l2_config_base](index.html) module"]
...
impl crate::Resettable for L2_CONFIG_BASE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0005_2000;
}
