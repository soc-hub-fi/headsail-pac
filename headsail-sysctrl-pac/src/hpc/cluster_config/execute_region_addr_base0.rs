...
pub type R = crate::R<ExecuteRegionAddrBase0Spec>;
#[doc = "Register `execute_region_addr_base0` writer"]
pub type W = crate::W<ExecuteRegionAddrBase0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn base(&mut self) -> BaseW<ExecuteRegionAddrBase0Spec> {
        BaseW::new(self, 0)
    }
}
...
pub struct ExecuteRegionAddrBase0Spec;
impl crate::RegisterSpec for ExecuteRegionAddrBase0Spec {
    type Ux = u64;
}
#[doc = "`read()` method returns [`execute_region_addr_base0::R`](R) reader structure"]
impl crate::Readable for ExecuteRegionAddrBase0Spec {}
#[doc = "`write(|w| ..)` method takes [`execute_region_addr_base0::W`](W) writer structure"]
impl crate::Writable for ExecuteRegionAddrBase0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
}
#[doc = "`reset()` method sets execute_region_addr_base0 to value 0"]
impl crate::Resettable for ExecuteRegionAddrBase0Spec {
