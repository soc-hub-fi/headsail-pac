...
pub struct R(crate::R<EXECUTE_REGION_ADDR_BASE0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EXECUTE_REGION_ADDR_BASE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EXECUTE_REGION_ADDR_BASE0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EXECUTE_REGION_ADDR_BASE0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `execute_region_addr_base0` writer"]
pub struct W(crate::W<EXECUTE_REGION_ADDR_BASE0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EXECUTE_REGION_ADDR_BASE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EXECUTE_REGION_ADDR_BASE0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EXECUTE_REGION_ADDR_BASE0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BASE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u64, EXECUTE_REGION_ADDR_BASE0_SPEC, u64, u64, 64, O>;
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
...
#[doc = "Base address for execute region #0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [execute_region_addr_base0](index.html) module"]
