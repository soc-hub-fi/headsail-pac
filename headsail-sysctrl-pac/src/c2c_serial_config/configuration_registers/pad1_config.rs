...
pub struct R(crate::R<PAD1_CONFIG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PAD1_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PAD1_CONFIG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PAD1_CONFIG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PAD1_CONFIG` writer"]
pub struct W(crate::W<PAD1_CONFIG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PAD1_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PAD1_CONFIG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PAD1_CONFIG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PAD_SER_DATA_TX_CONFIG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PAD1_CONFIG_SPEC, u16, u16, 10, O>;
