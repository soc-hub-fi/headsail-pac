...
pub struct R(crate::R<ADDRESS_MASKING_RX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ADDRESS_MASKING_RX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ADDRESS_MASKING_RX_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ADDRESS_MASKING_RX_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ADDRESS_MASKING_RX` writer"]
pub struct W(crate::W<ADDRESS_MASKING_RX_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ADDRESS_MASKING_RX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ADDRESS_MASKING_RX_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ADDRESS_MASKING_RX_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDRESS_MASKING_RX_R = crate::FieldReader<u32, u32>;
...
pub type ADDRESS_MASKING_RX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ADDRESS_MASKING_RX_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn address_masking_rx(&mut self) -> ADDRESS_MASKING_RX_W<0> {
        ADDRESS_MASKING_RX_W::new(self)
    }
