...
pub type R = crate::R<PADCFG6_SPEC>;
#[doc = "Register `PADCFG6` writer"]
pub type W = crate::W<PADCFG6_SPEC>;
#[doc = "Field `PADCFG6` reader - "]
pub type PADCFG6_R = crate::FieldReader<u32>;
#[doc = "Field `PADCFG6` writer - "]
pub type PADCFG6_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn padcfg6(&mut self) -> PADCFG6_W<PADCFG6_SPEC> {
        PADCFG6_W::new(self, 0)
    }
}
