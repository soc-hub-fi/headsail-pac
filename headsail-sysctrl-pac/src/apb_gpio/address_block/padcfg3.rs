...
pub type PADCFG3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PADCFG3` writer - "]
pub type PADCFG3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PADCFG3_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn padcfg3(&mut self) -> PADCFG3_W<0> {
        PADCFG3_W::new(self)
    }
