...
pub type R = crate::R<DESTINATION_ADDR_SPEC>;
#[doc = "Register `DESTINATION_ADDR` writer"]
pub type W = crate::W<DESTINATION_ADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn destination_address(&mut self) -> DESTINATION_ADDRESS_W<DESTINATION_ADDR_SPEC> {
