...
pub struct R(crate::R<SOURCE_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SOURCE_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SOURCE_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SOURCE_MODE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SOURCE_MODE` writer"]
pub struct W(crate::W<SOURCE_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SOURCE_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SOURCE_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SOURCE_MODE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SOURCE_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SOURCE_MODE_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
