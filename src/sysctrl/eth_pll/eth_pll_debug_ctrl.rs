...
pub struct R(crate::R<ETH_PLL_DEBUG_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_PLL_DEBUG_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_PLL_DEBUG_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_PLL_DEBUG_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ETH_PLL_DEBUG_CTRL` writer"]
pub struct W(crate::W<ETH_PLL_DEBUG_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ETH_PLL_DEBUG_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ETH_PLL_DEBUG_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ETH_PLL_DEBUG_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DEBUG_CTRL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ETH_PLL_DEBUG_CTRL_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eth_pll_debug_ctrl](index.html) module"]
