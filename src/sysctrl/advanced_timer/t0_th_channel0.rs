...
pub struct R(crate::R<T0_TH_CHANNEL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<T0_TH_CHANNEL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<T0_TH_CHANNEL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<T0_TH_CHANNEL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `T0_TH_CHANNEL0` writer"]
pub struct W(crate::W<T0_TH_CHANNEL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<T0_TH_CHANNEL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<T0_TH_CHANNEL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<T0_TH_CHANNEL0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T0_TH_CHANNEL0_SPEC, u16, u16, 16, O>;
...
pub type MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, T0_TH_CHANNEL0_SPEC, u8, MODE_A, 3, O>;
