...
pub type REG_TX_CH1_LEN1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `REG_TX_CH1_LEN1` writer - "]
pub type REG_TX_CH1_LEN1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_CH1_LEN1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_tx_ch1_len1(&mut self) -> REG_TX_CH1_LEN1_W<0> {
        REG_TX_CH1_LEN1_W::new(self)
    }
