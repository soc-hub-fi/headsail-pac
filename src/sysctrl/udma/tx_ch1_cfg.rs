#[doc = "Register `TX_CH1_CFG` reader"]
pub struct R(crate::R<TX_CH1_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TX_CH1_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TX_CH1_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TX_CH1_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TX_CH1_CFG` writer"]
pub struct W(crate::W<TX_CH1_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TX_CH1_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TX_CH1_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TX_CH1_CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TX_CH1_CFG_SPEC, u8, SIZE_A, 2, O>;
...
pub type MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, TX_CH1_CFG_SPEC, u8, MODE_A, 2, O>;
...
#[doc = "FILTER tx channel configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tx_ch1_cfg](index.html) module"]
pub struct TX_CH1_CFG_SPEC;
impl crate::RegisterSpec for TX_CH1_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tx_ch1_cfg::R](R) reader structure"]
impl crate::Readable for TX_CH1_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tx_ch1_cfg::W](W) writer structure"]
impl crate::Writable for TX_CH1_CFG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TX_CH1_CFG to value 0"]
impl crate::Resettable for TX_CH1_CFG_SPEC {
