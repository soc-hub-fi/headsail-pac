...
pub struct R(crate::R<SPIM_TX_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPIM_TX_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPIM_TX_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPIM_TX_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPIM_TX_CFG` writer"]
pub struct W(crate::W<SPIM_TX_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPIM_TX_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPIM_TX_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPIM_TX_CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CONTINOUS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPIM_TX_CFG_SPEC, bool, O>;
...
pub type DATASIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPIM_TX_CFG_SPEC, u8, DATASIZE_A, 2, O>;
...
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPIM_TX_CFG_SPEC, bool, O>;
...
pub type CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPIM_TX_CFG_SPEC, bool, O>;
impl R {
...
#[doc = "TX SPI uDMA transfer configuration\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spim_tx_cfg](index.html) module"]
pub struct SPIM_TX_CFG_SPEC;
impl crate::RegisterSpec for SPIM_TX_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spim_tx_cfg::R](R) reader structure"]
impl crate::Readable for SPIM_TX_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spim_tx_cfg::W](W) writer structure"]
impl crate::Writable for SPIM_TX_CFG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SPIM_TX_CFG to value 0x04"]
impl crate::Resettable for SPIM_TX_CFG_SPEC {
