...
pub type REG_BINCU_SETUP_R = crate::FieldReader<u32, u32>;
#[doc = "Field `REG_BINCU_SETUP` writer - "]
pub type REG_BINCU_SETUP_W<'a, const O: u8> =
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_bincu_setup(&mut self) -> REG_BINCU_SETUP_W<0> {
        REG_BINCU_SETUP_W::new(self)
    }
