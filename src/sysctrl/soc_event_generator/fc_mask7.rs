...
pub struct R(crate::R<FC_MASK7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FC_MASK7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FC_MASK7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FC_MASK7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FC_MASK7` writer"]
pub struct W(crate::W<FC_MASK7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FC_MASK7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FC_MASK7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FC_MASK7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FC_MASK7_R = crate::FieldReader<u32, u32>;
#[doc = "Field `FC_MASK7` writer - Event Mask to enable/disable event dispatch to FC interrupt controller. Setting bit\\[i\\]
to 0b1 disables dispatching event to FC interrupt controller. Setting bit\\[i\\]
to 0b0 enables dispatching event to FC interrupt controller."]
pub type FC_MASK7_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FC_MASK7_SPEC, u32, u32, 32, O>;
impl R {
...
to 0b0 enables dispatching event to FC interrupt controller."]
    #[inline(always)]
    #[must_use]
    pub fn fc_mask7(&mut self) -> FC_MASK7_W<0> {
        FC_MASK7_W::new(self)
    }
