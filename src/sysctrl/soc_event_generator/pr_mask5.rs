...
pub struct R(crate::R<PR_MASK5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PR_MASK5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PR_MASK5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PR_MASK5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PR_MASK5` writer"]
pub struct W(crate::W<PR_MASK5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PR_MASK5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PR_MASK5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PR_MASK5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PR_MASK5_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PR_MASK5` writer - Event Mask to enable/disable event dispatch to peripherals. Setting bit\\[i\\]
to 0b1 disables dispatching event to peripherals. Setting bit\\[i\\]
to 0b0 enables dispatching event to peripherals."]
pub type PR_MASK5_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PR_MASK5_SPEC, u32, u32, 32, O>;
impl R {
...
to 0b0 enables dispatching event to peripherals."]
    #[inline(always)]
    #[must_use]
    pub fn pr_mask5(&mut self) -> PR_MASK5_W<0> {
        PR_MASK5_W::new(self)
    }
