...
pub type PR_MASK6_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PR_MASK6` writer - Event Mask to enable/disable event dispatch to peripherals. Setting bit\\[i\\]
to 0b1 disables dispatching event to peripherals. Setting bit\\[i\\]
to 0b0 enables dispatching event to peripherals."]
pub type PR_MASK6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PR_MASK6_SPEC, u32, u32, 32, O>;
impl R {
...
to 0b0 enables dispatching event to peripherals."]
    #[inline(always)]
    #[must_use]
    pub fn pr_mask6(&mut self) -> PR_MASK6_W<0> {
        PR_MASK6_W::new(self)
    }
