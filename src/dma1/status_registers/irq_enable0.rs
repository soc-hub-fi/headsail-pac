#[doc = "Register `IRQ_ENABLE0` reader"]
pub struct R(crate::R<IRQ_ENABLE0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IRQ_ENABLE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IRQ_ENABLE0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IRQ_ENABLE0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IRQ_ENABLE0` writer"]
pub struct W(crate::W<IRQ_ENABLE0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IRQ_ENABLE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IRQ_ENABLE0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IRQ_ENABLE0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WR_TRANSFER_COMPLETED_0_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, IRQ_ENABLE0_SPEC, bool, O>;
...
pub type RB_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IRQ_ENABLE0_SPEC, bool, O>;
#[doc = "Field `wb_error` reader - "]
pub type WB_ERROR_R = crate::BitReader<bool>;
#[doc = "Field `wb_error` writer - "]
pub type WB_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IRQ_ENABLE0_SPEC, bool, O>;
#[doc = "Field `fifo_overflow` reader - "]
pub type FIFO_OVERFLOW_R = crate::BitReader<bool>;
#[doc = "Field `fifo_overflow` writer - "]
pub type FIFO_OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, u32, IRQ_ENABLE0_SPEC, bool, O>;
#[doc = "Field `fifo_underflow` reader - "]
pub type FIFO_UNDERFLOW_R = crate::BitReader<bool>;
#[doc = "Field `fifo_underflow` writer - "]
pub type FIFO_UNDERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, u32, IRQ_ENABLE0_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
#[doc = "Configuring which of the interrupts are routed to the IRQ pin for Channels(0-3). Enabling each intterupt signal by setting corresponding bit. All of the interrupts can be enabled and disabled independent from each other.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [irq_enable0](index.html) module"]
pub struct IRQ_ENABLE0_SPEC;
impl crate::RegisterSpec for IRQ_ENABLE0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [irq_enable0::R](R) reader structure"]
impl crate::Readable for IRQ_ENABLE0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [irq_enable0::W](W) writer structure"]
impl crate::Writable for IRQ_ENABLE0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IRQ_ENABLE0 to value 0"]
impl crate::Resettable for IRQ_ENABLE0_SPEC {
